window.Lessons.lesson2.modules[19] = {
    ...
    <p class="text-sm italic text-gray-400 mt-4">Mission: Type "SEND" to transfer your website files to the global server.</p>`,
    ...
    widgetCode: `
        <div id="net-lab" style="padding:15px; background:#111; border-radius:8px; display:flex; flex-direction:column; height: 100%; min-height: 250px; position:relative; overflow:hidden;">
            ...
            <div id="net-msg" style="text-align:center; margin-top:15px; font-weight:bold; min-height:48px; color:#aaa;">Connection established. Ready to receive.</div>
        </div>
        <script>
            (function() {
                ...
                var lab = document.getElementById('net-lab');
                ...
                function handleInput(e) {
                    if (!document.getElementById('net-lab')) {
                    ...
                    if (val.includes("SEND") && !sending && !window.m20_done) {
                        sending = true;
