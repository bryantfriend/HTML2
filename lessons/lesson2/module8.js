window.Lessons.lesson2.modules[7] = {
    ...
    widgetCode: `
        <div id="fight-club" style="padding:15px; text-align:center; background:#111; border: 2px solid #555; border-radius:8px; display:flex; flex-direction:column; height: 100%; min-height: 250px; position:relative; overflow:hidden;">
            <div style="font-weight:bold; color:var(--neon-pink); margin-bottom:10px; font-size:18px;">🥊 TEXT FIGHT CLUB</div>
            ...
            <button id="play-fight-btn" style="display:none; margin:10px auto; padding:8px 16px; background:var(--neon-pink); color:black; font-weight:bold; border-radius:4px; cursor:pointer; min-height:36px;" class="hover:bg-pink-300">Fight!</button>
            
            <div id="fight-msg" style="text-align:center; margin-top:5px; font-weight:bold; min-height:48px; color:#aaa;">🔔 Ding!<br>Both words look the same.</div>
        </div>
        <script>
            (function() {
                ...
                var playBtn = document.getElementById('play-fight-btn');
                var fightClub = document.getElementById('fight-club');
                
                window.m8_done = false;
                var isFighting = false;
                
                function runFight(type) {
                    ...
                    if (type === 'both') {
                        ...
                        completeRound();
                        setTimeout(function() { isFighting = false; }, 1000);
                    } else if (type === 'strong') {
                        f1.style.fontWeight = "bold";
                        f1.style.color = "var(--neon-cyan)";
                        ...
                        setTimeout(function() {
                            ...
                            f2.innerHTML = "weak 💥";
                            fightClub.style.animation = "intense-shake 0.1s ease 3 alternate"; // shake
                        }, 1000);
                        ...
                        setTimeout(function() {
                            ...
                            f1.innerHTML = "💥 Strong";
                            fightClub.style.animation = "intense-shake 0.1s ease 3 alternate";
                        }, 1000);
                        ...
                        setTimeout(function() {
                            ...
                            setTimeout(function() { isFighting = false; }, 1500);
                        }, 1500);
                    }
                }
                ...
                function handleInput(e) {
                    ...
                    playBtn.style.display = "none";
                    msg.innerHTML = "🔔 Ding!<br>Both words look the same.";
                    msg.style.color = "#aaa";

                    if (bothBold) {
                        playBtn.style.display = "block";
                        playBtn.onclick = function() { runFight('both'); };
                    } else if (strongBold) {
                        playBtn.style.display = "block";
                        playBtn.onclick = function() { runFight('strong'); };
                    } else if (weakBold) {
                        playBtn.style.display = "block";
                        playBtn.onclick = function() { runFight('weak'); };
                    }
                }
