window.Lessons.exam2.modules[5] = {
    title: "6. Italic Feeling",
    body: `<section class="quest-body">
    <p class="quest-kicker">Text Tags</p>
    <h3 class="quest-title">6. Italic Feeling</h3>
    <p class="quest-summary">Emphasized text leans and helps a word feel special.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The highlighted word looks different right away.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Spot the tilted word in the preview card.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Wrap the word <code>exciting</code> with <code>&lt;em&gt;</code> tags.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>&lt;em&gt;</code> emphasizes a word.</div>
    <p class="quest-mission">Mission: Add one emphasized word.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#c4b5fd"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Small emphasis</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">A tiny tag can change the feeling.</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Emphasis makes a word feel different.</h4>
      </div>
      <span class="quest-chip">type em</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;em&gt;exciting&lt;/em&gt;</pre>
        </div>
        <div class="quest-demo-panel">
    ...
    <div style="padding:10px 12px;border-radius:14px;background:#ddd6fe;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Emphasis</div>
    <p style="margin:0;font:700 15px/1.5 Arial,sans-serif;">HTML is <em>exciting</em>.</p>
  </div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the em tag before the special word.</p><p class="quest-caption">Keep the rest of the sentence outside it.</p><p class="quest-caption">Close the em tag right after the word.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 30,
    validator: function(code) { return /<\s*em\b[^>]*>[\s\S]*?exciting[\s\S]*?<\s*\/\s*em\s*>/i.test(code); }
};