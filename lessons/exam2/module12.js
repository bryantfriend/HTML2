window.Lessons.exam2.modules[11] = {
    title: "12. Which tag adds a line break?",
  ...
  <div class="flex flex-wrap items-center justify-between gap-3">
    <h3 class="heading-font text-2xl text-white">12. Which tag adds a line break?</h3>
    <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 12 of 50</span>
  </div>
...
<div class="exam2-shell" id="exam2-q12">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Which tag adds a line break?</h4>
    </div>
  ...
  <div class="exam2-option-grid"><button type="button" class="exam2-option" data-value="wrong2" data-correct="false"><strong>A. &lt;body&gt;</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong1" data-correct="false"><strong>B. &lt;hr&gt;</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong3" data-correct="false"><strong>C. &lt;main&gt;</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="correct" data-correct="true"><strong>D. &lt;br&gt;</strong><span>Tap to choose this answer.</span></button></div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: "<!-- Question 12: click one answer on the left to save it. -->",
