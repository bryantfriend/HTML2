window.Lessons.exam2.modules[11] = {
    title: "12. Text Input",
    body: `<section class="quest-body">
    <p class="quest-kicker">Forms</p>
    <h3 class="quest-title">12. Text Input</h3>
    <p class="quest-summary">A text input gives the student a place to type words.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The field appears as soon as the input tag is added.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Use the exact <code>type="text"</code> value.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Inside the form, type <code>&lt;input type="text"&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Text fields use <code>type="text"</code>.</div>
    <p class="quest-mission">Mission: Add a text input inside the form.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Typing field</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Students know this one fast.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M12_TYPE"
      data-success="Right. A normal typing box uses type="text"."
      data-retry="Try again. Think plain typing field."
      data-correct="text"
      data-multi="false">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">Which input type makes a normal typing box?</h4>
      </div>
      <span class="quest-chip">1 easy answer</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Pick the best type, then type it in the editor.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="text"><span>text</span><small>A normal typing field.</small></button><button type="button" class="quest-choice-btn" data-value="checkbox"><span>checkbox</span><small>A tiny box you check.</small></button><button type="button" class="quest-choice-btn" data-value="radio"><span>radio</span><small>A choice dot.</small></button>
    </div>
    <p class="quest-status" id="exam2-12-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 60,
    validator: function(code) { return code.includes("<!-- EX2_M12_TYPE -->") && /<\s*input\b/i.test(code) && /\btype\s*=\s*["']text["']/i.test(code); }
};