window.Lessons.exam2.modules[2] = {
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <h3 class="heading-font text-2xl text-white">3. Type the Doctype</h3>
      <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 3 of 20</span>
    </div>
    <p class="text-[15px] leading-7 text-slate-200">Type the first line used in a normal HTML file.</p>
    <div class="grid gap-3 md:grid-cols-3">
      <div class="rounded-2xl border border-slate-400/10 bg-slate-900/60 p-3 text-sm text-slate-200"><strong class="block text-[11px] uppercase tracking-[0.18em] text-cyan-300">Format</strong>Type the line in the editor, then press Submit Answer.</div>
...
<div class="exam2-shell" id="exam2-q3">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Type the doctype line.</h4>
    </div>
  ...
  <p class="exam2-prompt">Use lowercase html to match the common version.</p>
  <div class="exam2-code-target">&lt;!DOCTYPE html&gt;</div>
...
(function() {
  ...
  if (submitButton) {
    submitButton.addEventListener('click', function() {
      ...
      const correct = (/<!doctype\\s+html>/i.test(code));
