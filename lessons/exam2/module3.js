window.Lessons.exam2.modules[2] = {
    title: "3. Add a Paragraph",
    body: `<section class="quest-body">
    <p class="quest-kicker">Text Tags</p>
    <h3 class="quest-title">3. Add a Paragraph</h3>
    <p class="quest-summary">Paragraph tags hold normal sentence text on a page.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The heading stays bold while the paragraph sits underneath it.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Look for the sentence block in the preview card.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Type <code>&lt;p&gt;I am learning HTML.&lt;/p&gt;</code> under the heading.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>&lt;p&gt;</code> is for a paragraph of text.</div>
    <p class="quest-mission">Mission: Add one paragraph.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#93c5fd"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Heading + paragraph</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">The page gets real content now.</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Most pages mix headings and paragraphs.</h4>
      </div>
      <span class="quest-chip">type p</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;p&gt;I am learning HTML.&lt;/p&gt;</pre>
        </div>
        <div class="quest-demo-panel">
    ...
    <div style="padding:10px 12px;border-radius:14px;background:#dbeafe;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Paragraph</div>
    <p style="margin:0;color:#334155;font:700 15px/1.5 Arial,sans-serif;">I am learning HTML.</p>
  </div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the paragraph tag.</p><p class="quest-caption">Write the sentence inside it.</p><p class="quest-caption">Close the tag so the browser knows where the paragraph ends.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 15,
    validator: function(code) { return /<\s*p\b[^>]*>[\s\S]*?i\s*am\s*learning\s*html[\s\S]*?<\s*\/\s*p\s*>/i.test(code); }
};