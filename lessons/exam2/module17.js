window.Lessons.exam2.modules[16] = {
    title: "17. Semantic Page Shell",
    body: `<section class="quest-body">
    <p class="quest-kicker">Semantic HTML</p>
    <h3 class="quest-title">17. Semantic Page Shell</h3>
    <p class="quest-summary">Semantic tags give the big areas of a page clear jobs.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Top, middle, and bottom each get their own named section.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Tap the order first, then type the tags.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>&lt;header&gt;</code>, <code>&lt;main&gt;</code>, and <code>&lt;footer&gt;</code> in that order.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Header = top, main = middle, footer = bottom.</div>
    <p class="quest-mission">Mission: Build the semantic shell.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Top • Middle • Bottom</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Easy page map review.</text>
  </svg></div>
<div class="quest-widget-shell quest-sequence-shell"
      data-quest-sequence="true"
      data-marker="EX2_M17_FLOW"
      data-success="Perfect. That is a clean page shell."
    ...
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Tap the page parts in order.</h4>
      </div>
    ...
    <div class="quest-sequence-buttons">
      <button type="button" class="quest-sequence-btn" data-value="header">Header first</button><button type="button" class="quest-sequence-btn" data-value="main">Main second</button><button type="button" class="quest-sequence-btn" data-value="footer">Footer third</button>
    </div>
    <p class="quest-status" id="exam2-17-status">Tap the buttons in the correct order.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 85,
    validator: function(code) { return code.includes("<!-- EX2_M17_FLOW -->") && /<\s*header\b/i.test(code) && /<\s*\/\s*header\s*>/i.test(code) && /<\s*main\b/i.test(code) && /<\s*\/\s*main\s*>/i.test(code) && /<\s*footer\b/i.test(code) && /<\s*\/\s*footer\s*>/i.test(code); }
};