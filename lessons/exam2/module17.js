window.Lessons.exam2.modules[16] = {
    title: "17. Which attribute describes an image with words?",
  ...
  <div class="flex flex-wrap items-center justify-between gap-3">
    <h3 class="heading-font text-2xl text-white">17. Which attribute describes an image with words?</h3>
    <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 17 of 50</span>
  </div>
...
<div class="exam2-shell" id="exam2-q17">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Which attribute describes an image with words?</h4>
    </div>
  ...
  <div class="exam2-option-grid"><button type="button" class="exam2-option" data-value="wrong1" data-correct="false"><strong>A. src</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong2" data-correct="false"><strong>B. id</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="correct" data-correct="true"><strong>C. alt</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong3" data-correct="false"><strong>D. method</strong><span>Tap to choose this answer.</span></button></div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: "<!-- Question 17: click one answer on the left to save it. -->",
