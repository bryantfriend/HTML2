window.Lessons.exam2.modules[3] = {
    title: "4. What does `<!DOCTYPE html>` tell the browser?",
  ...
  <div class="flex flex-wrap items-center justify-between gap-3">
    <h3 class="heading-font text-2xl text-white">4. What does \`&lt;!DOCTYPE html&gt;\` tell the browser?</h3>
    <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 4 of 50</span>
  </div>
...
<div class="exam2-shell" id="exam2-q4">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">What does \`&lt;!DOCTYPE html&gt;\` tell the browser?</h4>
    </div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: "<!-- Question 4: click one answer on the left to save it. -->",
