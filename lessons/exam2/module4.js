window.Lessons.exam2.modules[3] = {
    title: "4. True or False: Break Line",
    body: `<section class="quest-body">
    <p class="quest-kicker">Text Tags</p>
    <h3 class="quest-title">4. True or False: Break Line</h3>
    <p class="quest-summary">A line break is a tiny tag that jumps text to the next line.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">See the two short lines stack instead of sitting side by side.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Pick true or false, then add the break tag in the code.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Put <code>&lt;br&gt;</code> between <code>Hello</code> and <code>World</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>&lt;br&gt;</code> does not need a closing tag here.</div>
    <p class="quest-mission">Mission: Use a line break correctly.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#fde68a"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Hello</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">World on the next line.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M4_TRUE"
      data-success="Correct. A line break moves the next text to a new line."
      data-retry="Try again. Think of pressing Enter once."
      data-correct="true"
      data-multi="false">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">True or false: The <br> tag moves text to a new line.</h4>
      </div>
    ...
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="true"><span>True</span><small>It starts a new line.</small></button><button type="button" class="quest-choice-btn" data-value="false"><span>False</span><small>It keeps everything on one line.</small></button>
    </div>
    <p class="quest-status" id="exam2-4-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 20,
    validator: function(code) { return code.includes("<!-- EX2_M4_TRUE -->") && /<\s*br\b/i.test(code); }
};