window.Lessons.exam2.modules[6] = {
    title: "7. Build a Bullet List",
    body: `<section class="quest-body">
    <p class="quest-kicker">Lists</p>
    <h3 class="quest-title">7. Build a Bullet List</h3>
    <p class="quest-summary">Unordered lists show bullet points for items that do not need numbers.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The preview turns plain words into a real bullet list.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Notice the bullets appear automatically.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>&lt;ul&gt;</code> with 2 items: <code>Apples</code> and <code>Bananas</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>&lt;ul&gt;</code> goes outside and <code>&lt;li&gt;</code> goes inside.</div>
    <p class="quest-mission">Mission: Create a 2-item bullet list.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Bullets = unordered list</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Great for favorites and supplies.</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">A bullet list keeps items neat.</h4>
      </div>
      <span class="quest-chip">ul + li</span>
    </div>
...
&lt;/ul&gt;</pre>
    ...
    <div style="padding:10px 12px;border-radius:14px;background:#dcfce7;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">List</div>
    <ul style="margin:0;padding-left:24px;"><li>Apples</li><li>Bananas</li></ul>
  </div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Start with the ul tag.</p><p class="quest-caption">Add one li for each item.</p><p class="quest-caption">Close both the li tags and the ul tag.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 35,
    validator: function(code) { return /<\s*ul\b/i.test(code) && /<\s*\/\s*ul\s*>/i.test(code) && (code.match(/<\s*li\b/gi) || []).length >= 2 && /apples/i.test(code) && /bananas/i.test(code); }
};