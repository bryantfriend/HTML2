window.Lessons.exam2.modules[19] = {
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <h3 class="heading-font text-2xl text-white">20. Type the Footer Tag Pair</h3>
      <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 20 of 20</span>
    </div>
    <p class="text-[15px] leading-7 text-slate-200">Create the opening and closing footer tags.</p>
...
<div class="exam2-shell" id="exam2-q20">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Type the footer shell.</h4>
    </div>
  ...
  <p class="exam2-prompt">Use the exact semantic tag pair shown below.</p>
  <div class="exam2-code-target">&lt;footer&gt;&lt;/footer&gt;</div>
...
(function() {
  ...
  if (submitButton) {
    submitButton.addEventListener('click', function() {
      ...
      const correct = (/<\\s*footer\\b[^>]*>\\s*<\\s*\\/\\s*footer\\s*>/i.test(code));
