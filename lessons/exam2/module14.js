window.Lessons.exam2.modules[13] = {
    ...
    <h3 class="quest-title">14. Send Button</h3>
    <p class="quest-summary">Buttons let students click to submit or continue.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The bright button appears at the bottom of the form.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Choose the tag that makes a real button.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>&lt;button&gt;Send&lt;/button&gt;</code> inside the form.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Buttons use the <code>&lt;button&gt;</code> tag.</div>
    <p class="quest-mission">Mission: Add a send button.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Button time</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Every form needs a way to click forward.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M14_BUTTON"
      data-success="Perfect. That is the button tag."
      data-retry="Try again. Look for the tag that creates a clickable button."
      data-correct="button"
      data-multi="false">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">Which tag makes a button?</h4>
      </div>
      <span class="quest-chip">1 answer</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Pick the button tag, then type it in the editor.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="button"><span>&lt;button&gt;</span><small>A clickable button element.</small></button><button type="button" class="quest-choice-btn" data-value="press"><span>&lt;press&gt;</span><small>This is not a real HTML tag.</small></button><button type="button" class="quest-choice-btn" data-value="click"><span>&lt;click&gt;</span><small>This is not a real HTML tag either.</small></button>
    </div>
    <p class="quest-status" id="exam2-14-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 70,
    validator: function(code) { return code.includes("<!-- EX2_M14_BUTTON -->") && /<\s*button\b[^>]*>[\s\S]*?send[\s\S]*?<\s*\/\s*button\s*>/i.test(code); }
};