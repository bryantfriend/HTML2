window.Lessons.exam2.modules[13] = {
    title: "14. Which tag usually makes italic text?",
  ...
  <div class="flex flex-wrap items-center justify-between gap-3">
    <h3 class="heading-font text-2xl text-white">14. Which tag usually makes italic text?</h3>
    <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 14 of 50</span>
  </div>
...
<div class="exam2-shell" id="exam2-q14">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Which tag usually makes italic text?</h4>
    </div>
  ...
  <div class="exam2-option-grid"><button type="button" class="exam2-option" data-value="wrong3" data-correct="false"><strong>A. &lt;form&gt;</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="correct" data-correct="true"><strong>B. &lt;i&gt;</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong2" data-correct="false"><strong>C. &lt;ul&gt;</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong1" data-correct="false"><strong>D. &lt;h3&gt;</strong><span>Tap to choose this answer.</span></button></div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: "<!-- Question 14: click one answer on the left to save it. -->",
