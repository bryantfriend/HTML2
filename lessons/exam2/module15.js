window.Lessons.exam2.modules[14] = {
    title: "15. Which tag adds an image?",
  ...
  <div class="flex flex-wrap items-center justify-between gap-3">
    <h3 class="heading-font text-2xl text-white">15. Which tag adds an image?</h3>
    <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 15 of 50</span>
  </div>
...
<div class="exam2-shell" id="exam2-q15">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Which tag adds an image?</h4>
    </div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: "<!-- Question 15: click one answer on the left to save it. -->",
