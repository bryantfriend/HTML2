window.Lessons.exam2.modules[14] = {
    title: "15. Head and Body Jobs",
    body: `<section class="quest-body">
    <p class="quest-kicker">Page Structure</p>
    <h3 class="quest-title">15. Head and Body Jobs</h3>
    <p class="quest-summary">The head stores behind-the-scenes page info, and the body holds the visible page content.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">One card is hidden info. The other is what the student sees.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Tap both correct job cards.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">No typing on this one. Just sort the jobs.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Body is for visible content.</div>
    <p class="quest-mission">Mission: Choose the correct jobs for head and body.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#bfdbfe"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Hidden info vs visible page</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">A simple but important split.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M15_READY"
      data-success="Great. Head holds page info and body shows page content."
      data-retry="Close. Pick the statements about hidden info and visible content."
      data-correct="head|body"
      data-multi="true">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">Tap the 2 true statements.</h4>
      </div>
      <span class="quest-chip">2 correct</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Find the jobs that really match head and body.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="head"><span>The head stores page info</span><small>Like title and meta tags.</small></button><button type="button" class="quest-choice-btn" data-value="body"><span>The body shows page content</span><small>Like headings, paragraphs, and images.</small></button><button type="button" class="quest-choice-btn" data-value="bodyhidden"><span>The body hides everything</span><small>That is not right.</small></button><button type="button" class="quest-choice-btn" data-value="headvisible"><span>The head shows the main page text</span><small>That is usually the body job.</small></button>
    </div>
    <p class="quest-status" id="exam2-15-status">Find every correct card.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 75,
    validator: function(code) { return code.includes("<!-- EX2_M15_READY -->"); }
};