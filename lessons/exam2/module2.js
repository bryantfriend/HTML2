window.Lessons.exam2.modules[1] = {
    title: "2. The Biggest Heading",
    body: `<section class="quest-body">
    <p class="quest-kicker">Text Tags</p>
    <h3 class="quest-title">2. The Biggest Heading</h3>
    <p class="quest-summary">Headings help readers know what a page is about right away.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Notice how a big title stands out in the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Read the heading card in the demo area.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Type <code>&lt;h1&gt;My First Page&lt;/h1&gt;</code> inside the body.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>&lt;h1&gt;</code> is the biggest heading tag.</div>
    <p class="quest-mission">Mission: Add one big page heading.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#a5f3fc"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Big title first</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Students can see it instantly.</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">A page title should be easy to spot.</h4>
      </div>
      <span class="quest-chip">type h1</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;h1&gt;My First Page&lt;/h1&gt;</pre>
        </div>
        <div class="quest-demo-panel">
    ...
    <div style="padding:10px 12px;border-radius:14px;background:#bfdbfe;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Heading</div>
    <h1 style="margin:0;font:900 28px/1.1 Arial,sans-serif;">My First Page</h1>
  </div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Start with an opening h1 tag.</p><p class="quest-caption">Put the title words in the middle.</p><p class="quest-caption">Close the h1 tag to finish the heading.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    initialCode: `<!DOCTYPE html>\n<html>\n<head>\n  <meta charset="UTF-8">\n  <title>HTML Final Mission</title>\n</head>\n<body>\n  <!-- Type your h1 heading below this line -->\n\n</body>\n</html>`,
    ...
    progress: 10,
    validator: function(code) { return /<\s*h1\b[^>]*>[\s\S]*?my\s*first\s*page[\s\S]*?<\s*\/\s*h1\s*>/i.test(code); }
};