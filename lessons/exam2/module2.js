window.Lessons.exam2.modules[1] = {
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <h3 class="heading-font text-2xl text-white">2. True or False: Browsers Read HTML</h3>
      <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 2 of 20</span>
    </div>
    <p class="text-[15px] leading-7 text-slate-200">Decide whether the statement is true or false.</p>
...
<div class="exam2-shell" id="exam2-q2">
  <div class="exam2-top">
    <div>
      <p class="exam2-kicker">Record One Answer</p>
      <h4 class="exam2-heading">A browser reads HTML and shows a webpage.</h4>
    </div>
...
(function() {
  ...
  function recordAnswer(correct, response) {
    ...
    window.exam2Answers['q2'] = { correct: !!correct, response: response };
    if (status) status.textContent = 'Answer recorded. Continue when you are ready.';
    if (editor) {
      editor.value = appendMarker(editor.value, 'EX2_Q2_SUBMITTED');
