window.Lessons.exam2.modules[15] = {
    ...
    <h3 class="quest-title">16. True or False: Doctype</h3>
    <p class="quest-summary">The doctype line tells the browser which kind of document it is reading.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">This one is an easy memory checkpoint.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Pick true or false.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">No typing needed here.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Most HTML pages begin with <code>&lt;!DOCTYPE html&gt;</code>.</div>
    <p class="quest-mission">Mission: Answer the doctype checkpoint.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#ddd6fe"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">First line matters</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">A fast confidence booster.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M16_TRUE"
      data-success="Correct. That line usually comes first."
      data-retry="Try again. Think first line of the page."
      data-correct="true"
      data-multi="false">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">True or false: Most HTML files start with <!DOCTYPE html>.</h4>
      </div>
    ...
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="true"><span>True</span><small>That is the usual first line.</small></button><button type="button" class="quest-choice-btn" data-value="false"><span>False</span><small>That is not right for a normal HTML page.</small></button>
    </div>
    <p class="quest-status" id="exam2-16-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    initialCode: `<!DOCTYPE html>\n<html>\n<head>\n  <meta charset="UTF-8">\n  <title>HTML Final Mission</title>\n</head>\n<body>\n  <p>Doctype is usually the first line above everything else.</p>\n\n</body>\n</html>`,
    ...
    progress: 80,
    validator: function(code) { return code.includes("<!-- EX2_M16_TRUE -->"); }
};