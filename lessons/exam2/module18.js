window.Lessons.exam2.modules[17] = {
    title: "18. Menu and Story",
    body: `<section class="quest-body">
    <p class="quest-kicker">Semantic HTML</p>
    <h3 class="quest-title">18. Menu and Story</h3>
    <p class="quest-summary">A nav tag can hold the menu, and an article tag can hold one full story.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The preview shows a menu block and a story block.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Pick the two semantic tags you need, then type them.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Put <code>&lt;nav&gt;</code> inside the header and <code>&lt;article&gt;</code> inside the main area.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Nav is for navigation. Article is for one full piece of content.</div>
    <p class="quest-mission">Mission: Add nav and article.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#86efac"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Menu + story</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Two easy semantic wins.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M18_READY"
      data-success="Yes. Nav fits the menu and article fits the story."
      data-retry="Try again. One tag is for the menu and one is for the main story card."
      data-correct="nav|article"
      data-multi="true">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">Which 2 tags fit this page best?</h4>
      </div>
      <span class="quest-chip">2 correct</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Pick the menu tag and the story tag.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="nav"><span>&lt;nav&gt;</span><small>A menu area with links.</small></button><button type="button" class="quest-choice-btn" data-value="article"><span>&lt;article&gt;</span><small>One full story or post.</small></button><button type="button" class="quest-choice-btn" data-value="blink"><span>&lt;blink&gt;</span><small>Not a real modern semantic tag.</small></button><button type="button" class="quest-choice-btn" data-value="bigbox"><span>&lt;bigbox&gt;</span><small>Also not a real HTML tag.</small></button>
    </div>
    <p class="quest-status" id="exam2-18-status">Find every correct card.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 90,
    validator: function(code) { return code.includes("<!-- EX2_M18_READY -->") && /<\s*nav\b/i.test(code) && /<\s*\/\s*nav\s*>/i.test(code) && /<\s*article\b/i.test(code) && /<\s*\/\s*article\s*>/i.test(code); }
};