window.Lessons.exam2.modules[4] = {
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <h3 class="heading-font text-2xl text-white">5. Type One Main Heading</h3>
      <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 5 of 20</span>
    </div>
    <p class="text-[15px] leading-7 text-slate-200">Create a large page title using an h1 tag.</p>
...
<div class="exam2-shell" id="exam2-q5">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Type one h1 heading.</h4>
    </div>
  ...
  <p class="exam2-prompt">Use the exact sample heading shown below.</p>
  <div class="exam2-code-target">&lt;h1&gt;My Page&lt;/h1&gt;</div>
...
(function() {
  ...
  if (submitButton) {
    submitButton.addEventListener('click', function() {
      ...
      const correct = (/<\\s*h1\\b[^>]*>\\s*my\\s*page\\s*<\\s*\\/\\s*h1\\s*>/i.test(code));
      recordAnswer(correct, String(code || '').trim().slice(0, 180));
    });
  }
})();
</script>`,
    initialCode: `<!DOCTYPE html>\n<html>\n<head>\n  <meta charset="UTF-8">\n  <title>Exam 2</title>\n</head>\n<body>\n  <!-- Type your main heading below -->\n\n</body>\n</html>`,
