window.Lessons.exam2.modules[4] = {
    title: "5. Make It Strong",
    body: `<section class="quest-body">
    <p class="quest-kicker">Text Tags</p>
    <h3 class="quest-title">5. Make It Strong</h3>
    <p class="quest-summary">Strong text makes an important word stand out.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The key word looks more powerful in the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Read the example word that pops out.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Wrap the word <code>important</code> with <code>&lt;strong&gt;</code> tags.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>&lt;strong&gt;</code> is a great choice for important text.</div>
    <p class="quest-mission">Mission: Make one word strong.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#f9a8d4"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Important words pop</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Students see the change fast.</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Strong text calls attention to the important part.</h4>
      </div>
      <span class="quest-chip">type strong</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      <div class="quest-browser">
        ...
        <div class="quest-browser-bar">index.html</div>
      </div>
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Code</p>
          <pre class="quest-demo-snippet">&lt;strong&gt;important&lt;/strong&gt;</pre>
        </div>
        <div class="quest-demo-panel">
    ...
    <div style="padding:10px 12px;border-radius:14px;background:#fbcfe8;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Strong</div>
    <p style="margin:0;font:700 15px/1.5 Arial,sans-serif;">This is <strong>important</strong>.</p>
  </div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the strong tag before the key word.</p><p class="quest-caption">Leave the other words outside it.</p><p class="quest-caption">Close the strong tag after the key word.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 25,
    validator: function(code) { return /<\s*strong\b[^>]*>[\s\S]*?important[\s\S]*?<\s*\/\s*strong\s*>/i.test(code); }
};