window.Lessons.exam2.modules[0] = {
    title: "1. What is HTML mainly used for?",
  ...
  <div class="flex flex-wrap items-center justify-between gap-3">
    <h3 class="heading-font text-2xl text-white">1. What is HTML mainly used for?</h3>
    <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 1 of 50</span>
  </div>
...
<div class="exam2-shell" id="exam2-q1">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">What is HTML mainly used for?</h4>
    </div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: "<!-- Question 1: click one answer on the left to save it. -->",
