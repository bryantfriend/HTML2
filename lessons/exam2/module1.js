window.Lessons.exam2.modules[0] = {
    title: "1. HTML Mission Start",
    body: `<section class="quest-body">
    <p class="quest-kicker">Final Mission</p>
    <h3 class="quest-title">1. HTML Mission Start</h3>
    <p class="quest-summary">This easy final is secretly one more guided practice lap. Tap the card that tells what HTML really does.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Look at the three page parts on the screen.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Tap the card that matches HTML.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">No typing yet. Warm up first.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> HTML gives a webpage its structure.</div>
    <p class="quest-mission">Mission: Choose the job of HTML.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">HTML = structure</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Easy points. Keep moving.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M1_READY"
      data-success="Nice. HTML builds the structure of a webpage."
      data-retry="Try again. Think structure, not paint or movement."
      data-correct="structure"
      data-multi="false">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">What is HTML mainly used for?</h4>
      </div>
      <span class="quest-chip">1 easy answer</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Pick the best job for HTML.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="structure"><span>Build the structure</span><small>Headings, paragraphs, images, forms, and page parts.</small></button><button type="button" class="quest-choice-btn" data-value="style"><span>Paint the colors</span><small>That is mostly CSS.</small></button><button type="button" class="quest-choice-btn" data-value="motion"><span>Make everything move</span><small>That is usually JavaScript.</small></button>
    </div>
    <p class="quest-status" id="exam2-1-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 5,
    validator: function(code) { return code.includes("<!-- EX2_M1_READY -->"); }
};