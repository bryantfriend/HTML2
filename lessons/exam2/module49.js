...
<div class="exam2-shell" id="exam2-q49">
  ...
  <div class="exam2-option-grid"><button type="button" class="exam2-option" data-value="wrong1" data-correct="false"><strong>A. The paint only</strong><span>Not the best answer</span></button><button type="button" class="exam2-option" data-value="wrong2" data-correct="false"><strong>B. The sound effects only</strong><span>Not the best answer</span></button><button type="button" class="exam2-option" data-value="correct" data-correct="true"><strong>C. The skeleton or structure</strong><span>Best answer</span></button><button type="button" class="exam2-option" data-value="wrong3" data-correct="false"><strong>D. The internet cable</strong><span>Not the best answer</span></button></div>
