window.Lessons.exam2.modules[8] = {
    ...
    <p class="quest-kicker">Images</p>
    <h3 class="quest-title">9. Easy Image Tag</h3>
    <p class="quest-summary">The image tag places a picture on the page.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">When the tag appears, the cat picture appears too.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Use the exact source shown in the mission text.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Type <code>&lt;img src="assets/exam-html-cat.svg"&gt;</code> inside the body.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>src</code> tells the browser where the image lives.</div>
    <p class="quest-mission">Mission: Show the cat image.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#7dd3fc"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Picture power</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">One tag, instant image.</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">The img tag can place a picture with one line.</h4>
      </div>
      <span class="quest-chip">type img</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      <div class="quest-browser">
        ...
        <div class="quest-browser-bar">images.html</div>
      </div>
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Code</p>
          <pre class="quest-demo-snippet">&lt;img src="assets/exam-html-cat.svg"&gt;</pre>
        </div>
        <div class="quest-demo-panel">
    ...
    <div style="padding:10px 12px;border-radius:14px;background:#dbeafe;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Image</div>
    <img src="assets/exam-html-cat.svg" alt="Cat" style="margin:0 auto;">
  </div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the img tag.</p><p class="quest-caption">Add the src attribute with the picture path.</p><p class="quest-caption">Close the tag with > so the picture can appear.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 45,
    validator: function(code) { return /<\s*img\b/i.test(code) && /\bsrc\s*=\s*["']assets\/exam-html-cat\.svg["']/i.test(code); }
};