window.Lessons.exam2.modules[8] = {
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 9 of 20</span>
    </div>
    <p class="text-[15px] leading-7 text-slate-200">Choose the list tag that numbers the items.</p>
...
<div class="exam2-shell" id="exam2-q9">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">A numbered list uses which outer tag?</h4>
    </div>
  ...
  <div class="exam2-option-grid cols-2"><button type="button" class="exam2-option" data-value="ol" data-correct="true"><strong>&lt;ol&gt;</strong><span>This creates an ordered numbered list.</span></button><button type="button" class="exam2-option" data-value="ul" data-correct="false"><strong>&lt;ul&gt;</strong><span>This creates bullets, not numbers.</span></button><button type="button" class="exam2-option" data-value="li" data-correct="false"><strong>&lt;li&gt;</strong><span>This is one item, not the whole list.</span></button></div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: `<!DOCTYPE html>\n<html>\n<head>\n  <meta charset="UTF-8">\n  <title>Exam 2</title>\n</head>\n<body>\n  <p>Question 9: choose one answer.</p>\n</body>\n</html>`,
