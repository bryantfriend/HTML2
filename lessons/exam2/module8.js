window.Lessons.exam2.modules[7] = {
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <h3 class="heading-font text-2xl text-white">8. Type the ul Tag Pair</h3>
      <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 8 of 20</span>
    </div>
    <p class="text-[15px] leading-7 text-slate-200">Type the opening and closing ul tags.</p>
...
<div class="exam2-shell" id="exam2-q8">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Type the unordered list shell.</h4>
    </div>
  ...
  <p class="exam2-prompt">No list items are needed for this question.</p>
  <div class="exam2-code-target">&lt;ul&gt;&lt;/ul&gt;</div>
...
(function() {
  ...
  if (submitButton) {
    submitButton.addEventListener('click', function() {
      ...
      const correct = (/<\\s*ul\\b[^>]*>\\s*<\\s*\\/\\s*ul\\s*>/i.test(code));
      recordAnswer(correct, String(code || '').trim().slice(0, 180));
    });
  }
})();
</script>`,
    initialCode: `<!DOCTYPE html>\n<html>\n<head>\n  <meta charset="UTF-8">\n  <title>Exam 2</title>\n</head>\n<body>\n  <!-- Type the ul tags here -->\n\n</body>\n</html>`,
