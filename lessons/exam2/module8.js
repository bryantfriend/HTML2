window.Lessons.exam2.modules[7] = {
    title: "8. Number the Steps",
    body: `<section class="quest-body">
    <p class="quest-kicker">Lists</p>
    <h3 class="quest-title">8. Number the Steps</h3>
    <p class="quest-summary">Ordered lists use numbers when the order matters.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The preview shows step 1 and step 2.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Think recipe steps or morning routines.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>&lt;ol&gt;</code> with 2 items: <code>Wake up</code> and <code>Eat breakfast</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> <code>&lt;ol&gt;</code> makes a numbered list.</div>
    <p class="quest-mission">Mission: Create a 2-step ordered list.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#fcd34d"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Numbers = ordered list</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Use it when sequence matters.</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Ordered lists are perfect for steps.</h4>
      </div>
      <span class="quest-chip">ol + li</span>
    </div>
...
&lt;/ol&gt;</pre>
    ...
    <div style="padding:10px 12px;border-radius:14px;background:#fef3c7;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Steps</div>
    <ol style="margin:0;padding-left:24px;"><li>Wake up</li><li>Eat breakfast</li></ol>
  </div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the ol tag for a numbered list.</p><p class="quest-caption">Add one li for each step.</p><p class="quest-caption">Close the ol tag when the list is done.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 40,
    validator: function(code) { return /<\s*ol\b/i.test(code) && /<\s*\/\s*ol\s*>/i.test(code) && (code.match(/<\s*li\b/gi) || []).length >= 2 && /wake\s*up/i.test(code) && /eat\s*breakfast/i.test(code); }
};