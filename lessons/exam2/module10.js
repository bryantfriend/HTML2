window.Lessons.exam2.modules[9] = {
    ...
    <h3 class="quest-title">10. Alt Text Helps</h3>
    <p class="quest-summary">Alt text explains an image if it does not load or if someone uses a screen reader.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The mission is easy: keep the same image and add the helpful words.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Pick the true statement, then type the alt text.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>alt="happy cat"</code> to the image tag.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Alt text describes the image.</div>
    <p class="quest-mission">Mission: Add helpful alt text.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#bae6fd"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Pictures need words too</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Alt text is part of good HTML.</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="EX2_M10_TRUE"
      data-success="Exactly. Alt text tells what the picture is."
      data-retry="Try again. Think description, not decoration."
      data-correct="true"
      data-multi="false">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">True or false: Alt text describes the picture.</h4>
      </div>
      <span class="quest-chip">true / false</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Pick the best answer.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="true"><span>True</span><small>Alt text describes the image.</small></button><button type="button" class="quest-choice-btn" data-value="false"><span>False</span><small>Alt text changes the color of the image.</small></button>
    </div>
    <p class="quest-status" id="exam2-10-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 50,
    validator: function(code) { return code.includes("<!-- EX2_M10_TRUE -->") && /\balt\s*=\s*["']happy\s*cat["']/i.test(code); }
};