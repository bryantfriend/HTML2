window.Lessons.exam2.modules[9] = {
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      <h3 class="heading-font text-2xl text-white">10. Type One List Item</h3>
      <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 10 of 20</span>
    </div>
    <p class="text-[15px] leading-7 text-slate-200">Add one list item inside the starter ul.</p>
...
<div class="exam2-shell" id="exam2-q10">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Type one list item.</h4>
    </div>
  ...
  <div class="exam2-code-target">&lt;li&gt;Item&lt;/li&gt;</div>
...
(function() {
  ...
  if (submitButton) {
    submitButton.addEventListener('click', function() {
      ...
      const correct = (/<\\s*li\\b[^>]*>\\s*item\\s*<\\s*\\/\\s*li\\s*>/i.test(code));
