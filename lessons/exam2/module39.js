...
<div class="exam2-shell" id="exam2-q39">
  ...
  <div class="exam2-option-grid"><button type="button" class="exam2-option" data-value="correct" data-correct="true"><strong>A. It says where the form data should go.</strong><span>Best answer</span></button><button type="button" class="exam2-option" data-value="wrong2" data-correct="false"><strong>B. It turns bullets into numbers.</strong><span>Not the best answer</span></button><button type="button" class="exam2-option" data-value="wrong3" data-correct="false"><strong>C. It adds a background image.</strong><span>Not the best answer</span></button><button type="button" class="exam2-option" data-value="wrong1" data-correct="false"><strong>D. It picks the font size.</strong><span>Not the best answer</span></button></div>
