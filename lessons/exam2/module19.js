window.Lessons.exam2.modules[18] = {
    title: "19. Which attribute can change image width?",
  ...
  <div class="flex flex-wrap items-center justify-between gap-3">
    <h3 class="heading-font text-2xl text-white">19. Which attribute can change image width?</h3>
    <span class="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-cyan-100">Question 19 of 50</span>
  </div>
...
<div class="exam2-shell" id="exam2-q19">
  <div class="exam2-top">
    <div>
      ...
      <h4 class="exam2-heading">Which attribute can change image width?</h4>
    </div>
  ...
  <div class="exam2-option-grid"><button type="button" class="exam2-option" data-value="correct" data-correct="true"><strong>A. width</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong1" data-correct="false"><strong>B. alt</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong2" data-correct="false"><strong>C. class</strong><span>Tap to choose this answer.</span></button><button type="button" class="exam2-option" data-value="wrong3" data-correct="false"><strong>D. lang</strong><span>Tap to choose this answer.</span></button></div>
...
(function() {
  ...
  buttons.forEach(function(button) {
    ...
    initialCode: "<!-- Question 19: click one answer on the left to save it. -->",
