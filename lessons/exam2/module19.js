window.Lessons.exam2.modules[18] = {
    title: "19. Final HTML Build",
    body: `<section class="quest-body">
    <p class="quest-kicker">Victory Build</p>
    <h3 class="quest-title">19. Final HTML Build</h3>
    <p class="quest-summary">Final easy build: show that you can put the most important HTML pieces together.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">This is not a trick. It is a guided wrap-up.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Use the checklist, then type the missing pieces.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Make sure your page includes an <code>&lt;h1&gt;</code>, a <code>&lt;p&gt;</code>, an <code>&lt;img&gt;</code>, a <code>&lt;form&gt;</code>, and a <code>&lt;button&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> If you can build a tiny page, you understand a lot already.</div>
    <p class="quest-mission">Mission: Build the tiny HTML page.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="28" y="26" width="264" height="18" rx="9" fill="#67e8f9"/>
    ...
    <text x="160" y="42" fill="#082f49" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Tiny page = big win</text>
    <text x="160" y="132" fill="#cbd5e1" font-size="12" text-anchor="middle" font-family="Arial, sans-serif">Finish strong and earn full marks.</text>
  </svg></div>
<div class="quest-widget-shell quest-toggle-shell" data-quest-toggle="true" data-marker="">
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Tap through the final checklist.</h4>
      </div>
      <span class="quest-chip">5 parts</span>
    </div>
    <div class="quest-toggle-tabs">
      <button type="button" class="quest-toggle-btn is-active" data-target="exam2-19-panel-0">Title</button><button type="button" class="quest-toggle-btn" data-target="exam2-19-panel-1">Text</button><button type="button" class="quest-toggle-btn" data-target="exam2-19-panel-2">Image</button><button type="button" class="quest-toggle-btn" data-target="exam2-19-panel-3">Form</button><button type="button" class="quest-toggle-btn" data-target="exam2-19-panel-4">Button</button>
    </div>
    <div class="quest-toggle-panels">
      <div class="quest-toggle-panel is-active" id="exam2-19-panel-0"><div style="width:100%;max-width:260px;padding:16px;border-radius:20px;background:linear-gradient(180deg,#ffffff,#f8fafc);box-shadow:inset 0 0 0 1px rgba(148,163,184,0.22);">
    <div style="padding:10px 12px;border-radius:14px;background:#dbeafe;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Need 1</div>
    <p style="margin:0;">A big heading at the top.</p>
  </div></div><div class="quest-toggle-panel" id="exam2-19-panel-1"><div style="width:100%;max-width:260px;padding:16px;border-radius:20px;background:linear-gradient(180deg,#ffffff,#f8fafc);box-shadow:inset 0 0 0 1px rgba(148,163,184,0.22);">
    <div style="padding:10px 12px;border-radius:14px;background:#fef3c7;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Need 2</div>
    <p style="margin:0;">A paragraph under the heading.</p>
  </div></div><div class="quest-toggle-panel" id="exam2-19-panel-2"><div style="width:100%;max-width:260px;padding:16px;border-radius:20px;background:linear-gradient(180deg,#ffffff,#f8fafc);box-shadow:inset 0 0 0 1px rgba(148,163,184,0.22);">
    <div style="padding:10px 12px;border-radius:14px;background:#dcfce7;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Need 3</div>
    <img src="assets/exam-html-cat.svg" alt="Cat" style="margin:0 auto;">
  </div></div><div class="quest-toggle-panel" id="exam2-19-panel-3"><div style="width:100%;max-width:260px;padding:16px;border-radius:20px;background:linear-gradient(180deg,#ffffff,#f8fafc);box-shadow:inset 0 0 0 1px rgba(148,163,184,0.22);">
    <div style="padding:10px 12px;border-radius:14px;background:#e0f2fe;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Need 4</div>
    <form style="margin:0;"><label>Name</label><input type="text"></form>
  </div></div><div class="quest-toggle-panel" id="exam2-19-panel-4"><div style="width:100%;max-width:260px;padding:16px;border-radius:20px;background:linear-gradient(180deg,#ffffff,#f8fafc);box-shadow:inset 0 0 0 1px rgba(148,163,184,0.22);">
    <div style="padding:10px 12px;border-radius:14px;background:#fee2e2;color:#0f172a;font:900 12px/1.2 Arial,sans-serif;text-transform:uppercase;letter-spacing:0.1em;margin-bottom:10px;">Need 5</div>
    <button type="button">Send</button>
  </div></div>
    </div>
    <p class="quest-status">Tap every checklist card, then finish the page in the editor.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 95,
    validator: function(code) { return /<\s*h1\b/i.test(code) && /<\s*p\b/i.test(code) && /<\s*img\b/i.test(code) && /<\s*form\b/i.test(code) && /<\s*button\b/i.test(code); }
};