window.Lessons.lesson6.modules[3] = {
    ...
    <h3 class="quest-title">4. Build the Menu</h3>
    <p class="quest-summary">A nav area often uses a list. That means <code>&lt;ul&gt;</code> on the outside and <code>&lt;li&gt;</code> items inside.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The list turns into menu choices.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Count the menu items in the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Inside the <code>&lt;nav&gt;</code>, add a <code>&lt;ul&gt;</code> and at least two <code>&lt;li&gt;</code> items. Example:<br><code>&lt;nav&gt;...&lt;ul&gt;&lt;li&gt;Home&lt;/li&gt;&lt;li&gt;About&lt;/li&gt;&lt;/ul&gt;...&lt;/nav&gt;</code></p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> One list can hold many menu links.</div>
    <p class="quest-mission">Mission: Build a simple nav menu.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="34" y="56" width="212" height="16" rx="8" fill="#fde68a"/>
    <rect x="34" y="80" width="164" height="40" rx="16" fill="#bbf7d0"/>
    <rect x="206" y="80" width="80" height="40" rx="16" fill="#fecdd3"/>
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Menu list</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Lists make neat menus.</h4>
      </div>
...
&lt;/nav&gt;</pre>
        ...
        <div class="quest-demo-panel">
          ...
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#fef3c7;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">NAV</div><div style="display:flex;gap:8px;flex-wrap:wrap;"><div style="padding:8px 12px;border-radius:999px;background:white;border:1px solid #f59e0b;font:700 12px/1 Arial,sans-serif;">Home</div><div style="padding:8px 12px;border-radius:999px;background:white;border:1px solid #f59e0b;font:700 12px/1 Arial,sans-serif;">About</div></div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Start with nav.</p><p class="quest-caption">Place a list inside it.</p><p class="quest-caption">Add list items for each menu choice.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 20,
    validator: function(code) { return /<\s*ul\b/i.test(code) && /<\s*\/\s*ul\s*>/i.test(code) && (code.match(/<\s*li\b/gi) || []).length >= 2; }
};