window.Lessons.lesson6.modules[14] = {
    ...
    <h3 class="quest-title">15. Table Data Cells</h3>
    <p class="quest-summary">Cells inside a row use the <code>&lt;td&gt;</code> tag.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Each cell holds one piece of data.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Count the two cells in the preview row.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add 2 <code>&lt;td&gt;</code> cells inside the row.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> td means table data.</div>
    <p class="quest-mission">Mission: Add two table data cells.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Fill the row</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Cells hold the data inside each row.</h4>
      </div>
      <span class="quest-chip">td</span>
    </div>
...
&lt;/tr&gt;</pre>
        ...
        <div class="quest-demo-panel">
          ...
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><table><tr><td>Nova</td><td>Speed</td></tr></table></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the row.</p><p class="quest-caption">Place two td cells inside it.</p><p class="quest-caption">Now build two cells in the editor.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 75,
    validator: function(code) { return (code.match(/<\s*td\b/gi) || []).length >= 2; }
};