window.Lessons.lesson6.modules[15] = {
    ...
    <h3 class="quest-title">16. Table Headers</h3>
    <p class="quest-summary">When a row labels the columns, use <code>&lt;th&gt;</code> instead of <code>&lt;td&gt;</code>.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Header cells usually look bold because they label the column.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Pick the better tag for labels like Name and Age.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Change the two cells to <code>&lt;th&gt;</code> tags.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> th is for heading cells.</div>
    <p class="quest-mission">Mission: Turn the label row into header cells.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Label the columns</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="TH_READY"
      data-success="Correct. th labels the columns."
    ...
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Which tag should label a table column?</h4>
      </div>
      <span class="quest-chip">one answer</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Tap the best tag for a column label row.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="th"><span>&lt;th&gt;</span><small>Use for label cells.</small></button><button type="button" class="quest-choice-btn" data-value="td"><span>&lt;td&gt;</span><small>Use for regular data cells.</small></button>
    </div>
    <p class="quest-status" id="lesson6-16-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 80,
    validator: function(code) { return code.includes("<!-- TH_READY -->") && (code.match(/<\s*th\b/gi) || []).length >= 2; }
};