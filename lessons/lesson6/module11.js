window.Lessons.lesson6.modules[10] = {
    ...
    <h3 class="quest-title">11. The Footer Tag</h3>
    <p class="quest-summary">The <code>&lt;footer&gt;</code> tag marks the bottom area of the page.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Footer sits at the very end of the page map.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Look for the bottom strip in the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add a <code>&lt;footer&gt;</code> outside main.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Footer = bottom section.</div>
    <p class="quest-mission">Mission: Add the footer to the page.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Bottom strip</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Footer closes the page layout.</h4>
      </div>
      <span class="quest-chip">bottom area</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;footer&gt;&lt;/footer&gt;</pre>
        </div>
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Preview</p>
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#c7d2fe;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">FOOTER</div><div style="font:700 13px/1.4 Arial,sans-serif;color:#475569;">Copyright, contact links, or closing notes.</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">The footer belongs at the bottom.</p><p class="quest-caption">It uses a normal opening and closing pair.</p><p class="quest-caption">Now type the footer tag pair.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 55,
    validator: function(code) { return /<\s*footer\b/i.test(code) && /<\s*\/\s*footer\s*>/i.test(code); }
};