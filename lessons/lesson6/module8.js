window.Lessons.lesson6.modules[7] = {
    ...
    <h3 class="quest-title">8. The Section Tag</h3>
    <p class="quest-summary">Use <code>&lt;section&gt;</code> for one related part of a page, like About, Services, or Contact.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Sections split a page into organized parts.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Imagine one section for each topic.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Create a <code>&lt;section&gt;&lt;/section&gt;</code> tag pair.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Section groups related content.</div>
    <p class="quest-mission">Mission: Create one section tag pair.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="34" y="56" width="150" height="16" rx="8" fill="#fde68a"/>
    <rect x="34" y="80" width="164" height="40" rx="16" fill="#bbf7d0"/>
    <rect x="206" y="80" width="80" height="40" rx="16" fill="#fecdd3"/>
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Split by topic</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Sections divide a page into topic areas.</h4>
      </div>
      <span class="quest-chip">topic zone</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;section&gt;&lt;/section&gt;</pre>
        </div>
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Preview</p>
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#ede9fe;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">SECTION</div><div style="font:700 13px/1.4 Arial,sans-serif;color:#475569;">One clear topic lives here.</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the section tag.</p><p class="quest-caption">Close the section tag.</p><p class="quest-caption">Now add the pair in the editor.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 40,
    validator: function(code) { return /<\s*section\b/i.test(code) && /<\s*\/\s*section\s*>/i.test(code); }
};