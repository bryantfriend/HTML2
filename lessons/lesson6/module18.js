window.Lessons.lesson6.modules[17] = {
    ...
    <h3 class="quest-title">18. Add a Caption</h3>
    <p class="quest-summary">A <code>&lt;caption&gt;</code> gives the whole table a title.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The caption appears above the table and explains what the grid is about.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Read the table title in the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>&lt;caption&gt;My Heroes&lt;/caption&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Caption names the whole table.</div>
    <p class="quest-mission">Mission: Add a caption to the table.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Name the table</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Captions make tables easier to understand.</h4>
      </div>
      <span class="quest-chip">caption</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;caption&gt;My Heroes&lt;/caption&gt;</pre>
        </div>
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Preview</p>
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><table><caption>My Heroes</caption><tr><th>Hero</th><th>Power</th></tr></table></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Caption sits inside the table.</p><p class="quest-caption">It gives the whole table a title.</p><p class="quest-caption">Now add the caption in your code.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 90,
    validator: function(code) { return /<\s*caption\b/i.test(code) && /<\s*\/\s*caption\s*>/i.test(code); }
};