window.Lessons.lesson6.modules[5] = {
    ...
    <h3 class="quest-title">6. The Article Tag</h3>
    <p class="quest-summary">An <code>&lt;article&gt;</code> is one complete piece of content, like a story, post, or news card.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The article sits inside the main area.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Think of one article as one self-contained story.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Put <code>&lt;article&gt;&lt;/article&gt;</code> inside main.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Article = one complete content piece.</div>
    <p class="quest-mission">Mission: Add an article inside the main tag.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">One full story</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Articles can stand on their own.</h4>
      </div>
      <span class="quest-chip">story card</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;main&gt;
  &lt;article&gt;&lt;/article&gt;
&lt;/main&gt;</pre>
        </div>
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Preview</p>
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#e9d5ff;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">ARTICLE</div><div style="font:700 13px/1.4 Arial, sans-serif;color:#334155;">A blog post, news story, or product card.</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Main wraps the page content.</p><p class="quest-caption">Article wraps one full story.</p><p class="quest-caption">Now add article to your code.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 30,
    validator: function(code) { return /<\s*article\b/i.test(code) && /<\s*\/\s*article\s*>/i.test(code); }
};