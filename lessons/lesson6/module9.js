window.Lessons.lesson6.modules[8] = {
    ...
    <h3 class="quest-title">9. Sections Inside an Article</h3>
    <p class="quest-summary">One article can contain smaller sections, like an intro section and a details section.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">See how one article can be split into parts.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Think of two mini-chunks inside the same story.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Put 2 <code>&lt;section&gt;</code> tags inside the article.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Article can hold many related sections.</div>
    <p class="quest-mission">Mission: Add two sections inside the article.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="34" y="56" width="178" height="16" rx="8" fill="#fde68a"/>
    <rect x="34" y="80" width="164" height="40" rx="16" fill="#bbf7d0"/>
    <rect x="206" y="80" width="80" height="40" rx="16" fill="#fecdd3"/>
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Article parts</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="SECTIONS_READY"
      data-success="Exactly. One story can have multiple sections."
      data-retry="Nice try. Pick the card that matches the mission."
      data-correct="intro|details"
      data-multi="true">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">Which cards could be sections inside one article?</h4>
      </div>
      <span class="quest-chip">2 correct</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Tap the 2 cards that could be parts of one story page.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="intro"><span>Intro section</span><small>A beginning part of the story.</small></button><button type="button" class="quest-choice-btn" data-value="details"><span>Details section</span><small>A middle part with more information.</small></button><button type="button" class="quest-choice-btn" data-value="separate"><span>Different website</span><small>That would not belong inside the same article.</small></button>
    </div>
    <p class="quest-status" id="lesson6-9-status">Find every correct card.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 45,
    validator: function(code) { return code.includes("<!-- SECTIONS_READY -->") && (code.match(/<\s*section\b/gi) || []).length >= 2; }
};