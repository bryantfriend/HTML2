window.Lessons.lesson6.modules[9] = {
    ...
    <h3 class="quest-title">10. The Aside Tag</h3>
    <p class="quest-summary">An <code>&lt;aside&gt;</code> is for related information that is not the main event, like a sidebar or helpful note.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The aside sits beside the main story.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Compare the main story card and the side note card.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add an <code>&lt;aside&gt;</code> next to the article.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Aside = helpful side content.</div>
    <p class="quest-mission">Mission: Add an aside near the article.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="34" y="56" width="164" height="16" rx="8" fill="#fde68a"/>
...
<div class="quest-widget-shell quest-toggle-shell" data-quest-toggle="true" data-marker="">
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Main content vs side content</h4>
      </div>
      <span class="quest-chip">compare</span>
    </div>
    <div class="quest-toggle-tabs">
      <button type="button" class="quest-toggle-btn is-active" data-target="lesson6-10-panel-0">Article</button><button type="button" class="quest-toggle-btn" data-target="lesson6-10-panel-1">Aside</button>
    </div>
    <div class="quest-toggle-panels">
      <div class="quest-toggle-panel is-active" id="lesson6-10-panel-0"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#e9d5ff;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">ARTICLE</div><div style="font:700 13px/1.4 Arial,sans-serif;color:#475569;">Main story lives here.</div></div></div><div class="quest-toggle-panel" id="lesson6-10-panel-1"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#fee2e2;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">ASIDE</div><div style="font:700 13px/1.4 Arial,sans-serif;color:#475569;">Related note, links, or tips.</div></div></div>
    </div>
    <p class="quest-status">Aside is related content, but not the main story.</p>
  </div>
<script>
(function() {
