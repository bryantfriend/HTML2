window.Lessons.lesson6.modules[0] = {
    ...
    <h3 class="quest-title">1. Escape the Div Soup</h3>
    <p class="quest-summary">Semantic HTML gives each part of the page a clear job instead of using endless mystery divs.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Watch the page map turn from messy to meaningful.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Tap the 3 tags that clearly describe page jobs.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">No typing yet. Solve the mini game first.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Semantic tags tell people and browsers what each area does.</div>
    <p class="quest-mission">Mission: Tap the 3 semantic tags.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Map the page</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="SEMANTIC_READY"
      data-success="Nice. Those tags explain the page structure."
      data-retry="Nice try. Pick the card that matches the mission."
      data-correct="header|main|footer"
      data-multi="true">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">Find the tags with real meaning.</h4>
      </div>
      <span class="quest-chip">3 correct</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Which tags tell the browser what part of the page they are?</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="header"><span>&lt;header&gt;</span><small>The top area of the page.</small></button><button type="button" class="quest-choice-btn" data-value="main"><span>&lt;main&gt;</span><small>The most important content.</small></button><button type="button" class="quest-choice-btn" data-value="footer"><span>&lt;footer&gt;</span><small>The bottom area of the page.</small></button><button type="button" class="quest-choice-btn" data-value="div"><span>&lt;div&gt;</span><small>A general box with no special meaning.</small></button><button type="button" class="quest-choice-btn" data-value="span"><span>&lt;span&gt;</span><small>A small inline wrapper.</small></button>
    </div>
    <p class="quest-status" id="lesson6-1-status">Find every correct card.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 5,
    validator: function(code) { return code.includes("<!-- SEMANTIC_READY -->"); }
};