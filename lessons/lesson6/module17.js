window.Lessons.lesson6.modules[16] = {
    ...
    <h3 class="quest-title">17. Add a Second Row</h3>
    <p class="quest-summary">A full table usually has one label row and more rows of actual data.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The second row adds the real information.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Notice the table now has one header row and one data row.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add another <code>&lt;tr&gt;</code> with 2 <code>&lt;td&gt;</code> cells.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> New data rows use td cells.</div>
    <p class="quest-mission">Mission: Build a two-row table.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Add data row</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Header row first, data row second.</h4>
      </div>
      <span class="quest-chip">2 rows</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;tr&gt;
  &lt;th&gt;Hero&lt;/th&gt;
  &lt;th&gt;Power&lt;/th&gt;
&lt;/tr&gt;
&lt;tr&gt;
...
&lt;/tr&gt;</pre>
        ...
        <div class="quest-demo-panel">
          ...
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><table><tr><th>Hero</th><th>Power</th></tr><tr><td>Nova</td><td>Speed</td></tr></table></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Start with the header row.</p><p class="quest-caption">Add a second row for data.</p><p class="quest-caption">Now create your own second row.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 85,
    validator: function(code) { return (code.match(/<\s*tr\b/gi) || []).length >= 2 && (code.match(/<\s*td\b/gi) || []).length >= 2; }
};