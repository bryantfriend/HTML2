window.Lessons.lesson6.modules[19] = {
    ...
    <h3 class="quest-title">20. Final Semantic Page</h3>
    <p class="quest-summary">Final mission: build a clean page shell with the right semantic tags in the right places.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Study the full semantic layout one more time.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Run the checklist in your head: header, nav, main, article, footer.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Create a page with a <code>&lt;header&gt;</code>, <code>&lt;nav&gt;</code>, <code>&lt;main&gt;</code>, <code>&lt;article&gt;</code>, and <code>&lt;footer&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Clear structure makes pages easier to read, search, and maintain.</div>
    <p class="quest-mission">Mission: Build the full semantic shell.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Final layout</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">A strong page layout uses clear semantic parts.</h4>
      </div>
      <span class="quest-chip">boss mission</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      <div class="quest-browser">
        ...
        <div class="quest-browser-bar">semantic-layout.html</div>
      </div>
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Code</p>
          <pre class="quest-demo-snippet">&lt;header&gt;
  &lt;nav&gt;&lt;/nav&gt;
&lt;/header&gt;
&lt;main&gt;
  &lt;article&gt;&lt;/article&gt;
...
&lt;footer&gt;&lt;/footer&gt;</pre>
        ...
        <div class="quest-demo-panel">
          ...
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#dbeafe;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">HEADER</div><div style="padding:12px;border-radius:14px;background:#fef3c7;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">NAV</div><div style="padding:12px;border-radius:14px;background:#dcfce7;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">MAIN</div><div style="padding:12px;border-radius:14px;background:#e9d5ff;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">ARTICLE</div><div style="padding:12px;border-radius:14px;background:#c7d2fe;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">FOOTER</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Build the top area first.</p><p class="quest-caption">Place the main story in the middle.</p><p class="quest-caption">Close the page with a footer.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 100,
    validator: function(code) { return /<\s*header\b/i.test(code) && /<\s*nav\b/i.test(code) && /<\s*main\b/i.test(code) && /<\s*article\b/i.test(code) && /<\s*footer\b/i.test(code); }
};