window.Lessons.lesson6.modules[6] = {
    ...
    <h3 class="quest-title">7. Article Headline</h3>
    <p class="quest-summary">Articles often use an <code>&lt;h2&gt;</code> for the story headline.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The headline tells readers what the article is about.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Spot the large title inside the article card.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add an <code>&lt;h2&gt;</code> inside the article.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> The page usually saves <code>&lt;h1&gt;</code> for the main page title.</div>
    <p class="quest-mission">Mission: Add an h2 headline inside the article.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Headline first</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Every good article needs a clear headline.</h4>
      </div>
      <span class="quest-chip">h2</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      <div class="quest-browser">
        ...
        <div class="quest-browser-bar">blog-layout.html</div>
      </div>
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Code</p>
          <pre class="quest-demo-snippet">&lt;article&gt;
  &lt;h2&gt;My Blog&lt;/h2&gt;
&lt;/article&gt;</pre>
        </div>
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Preview</p>
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#e9d5ff;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">ARTICLE</div><div style="font:900 18px/1.2 Arial,sans-serif;color:#111827;margin-bottom:6px;">My Blog</div><div style="font:600 13px/1.4 Arial,sans-serif;color:#475569;">A strong headline helps readers understand the story fast.</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Open the article.</p><p class="quest-caption">Place h2 inside it.</p><p class="quest-caption">Now type your h2 headline.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 35,
    validator: function(code) { return /<\s*h2\b/i.test(code); }
};