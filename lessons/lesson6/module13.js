window.Lessons.lesson6.modules[12] = {
    ...
    <h3 class="quest-title">13. Meet the Table Tag</h3>
    <p class="quest-summary">Tables are for grid information like schedules, scoreboards, or rosters.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">A table builds a grid of rows and columns.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Look at the scoreboard style preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Create a <code>&lt;table&gt;&lt;/table&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Use tables for real grid data.</div>
    <p class="quest-mission">Mission: Create the table tag pair.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Grid data</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Tables organize data in a grid.</h4>
      </div>
      <span class="quest-chip">grid</span>
    </div>
...
&lt;/table&gt;</pre>
      ...
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Start with the table tag.</p><p class="quest-caption">Rows and cells will go inside it.</p><p class="quest-caption">Now type the table pair in the editor.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 65,
    validator: function(code) { return /<\s*table\b/i.test(code) && /<\s*\/\s*table\s*>/i.test(code); }
};