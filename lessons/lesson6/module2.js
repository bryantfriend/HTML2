window.Lessons.lesson6.modules[1] = {
    ...
    <h3 class="quest-title">2. The Header Tag</h3>
    <p class="quest-summary">The <code>&lt;header&gt;</code> tag marks the top part of a page.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Notice the header sits at the top of the page map.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Look for the top strip in the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Type <code>&lt;header&gt;&lt;/header&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Header means top section.</div>
    <p class="quest-mission">Mission: Create a header tag pair.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Top of the page</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">The header is the top section.</h4>
      </div>
      <span class="quest-chip">top area</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;header&gt;&lt;/header&gt;</pre>
        </div>
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Preview</p>
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#dbeafe;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">HEADER</div><div style="font:700 13px/1.4 Arial, sans-serif;color:#334155;">Page title, logo, or top welcome area.</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Put header at the top.</p><p class="quest-caption">Header opens and closes like a normal pair tag.</p><p class="quest-caption">Now type the same pair in the editor.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 10,
    validator: function(code) { return /<\s*header\b/i.test(code) && /<\s*\/\s*header\s*>/i.test(code); }
};