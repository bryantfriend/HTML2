window.Lessons.lesson6.modules[4] = {
    ...
    <h3 class="quest-title">5. The Main Tag</h3>
    <p class="quest-summary">The <code>&lt;main&gt;</code> tag wraps the most important content on the page.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Main is the biggest content zone in the layout.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Look for the large center area in the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>&lt;main&gt;&lt;/main&gt;</code> below the header.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> A page should usually have one main section.</div>
    <p class="quest-mission">Mission: Create the main content area.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 150" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <text x="270" y="42" fill="#e0f2fe" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Main content</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Main holds the core content.</h4>
      </div>
      <span class="quest-chip">center stage</span>
    </div>
...
&lt;/main&gt;</pre>
        ...
        <div class="quest-demo-panel">
          ...
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#fff7ed,#fffbeb);box-shadow:inset 0 0 0 1px rgba(251,191,36,0.18);"><div style="padding:12px;border-radius:14px;background:#dcfce7;color:#0f172a;font:800 13px/1.2 Arial, sans-serif;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:8px;">MAIN</div><div style="font:700 13px/1.4 Arial, sans-serif;color:#334155;">The most important page content goes here.</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Header sits on top.</p><p class="quest-caption">Main sits below it.</p><p class="quest-caption">Now type the main tag pair.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 25,
    validator: function(code) { return /<\s*main\b/i.test(code) && /<\s*\/\s*main\s*>/i.test(code); }
};