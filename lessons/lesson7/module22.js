window.Lessons.lesson7.modules[21] = {
    ...
    svg: `<svg width='240' height='150' viewBox='0 0 240 150' xmlns='http://www.w3.org/2000/svg' id="m22-svg" style="background:#1e293b; border-radius:8px;">
        ...
        <text id="m22-selected-emoji" x="120" y="110" fill="white" font-size="50" text-anchor="middle">🤔</text>
    </svg>`,
...
(function() {
    ...
    const emojiDisplay = document.getElementById('m22-selected-emoji');
