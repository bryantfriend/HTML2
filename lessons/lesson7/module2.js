window.Lessons.lesson7.modules[1] = {
    ...
    body: `<p>To write CSS inside an HTML file, we wrap it in a `<style>` tag, usually placed at the top of the page.</p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Create an opening and closing `<style>` tag.</p>`,
