window.Lessons.lesson7.modules[8] = {
    title: "9. Font Family",
    body: `<p>Tired of the default font? Change it using `font-family`.</p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Change the `font-family` to `sans-serif;`</p>`,
