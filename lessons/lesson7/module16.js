window.Lessons.lesson7.modules[15] = {
    ...
    body: `<p>Want to yell? \`text-transform: uppercase;\` will make all letters capital automatically!</p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Make the h1 uppercase.</p>`,
