window.Lessons.exam1.modules[15] = {
    title: "16. Exam Question 16",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 16 of 30</p>
  <p class="exam1-question">Which tag starts an ordered list with numbers?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(16, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;ul&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(16, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;order&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(16, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;li&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(16, 'D', true)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;ol&gt;</code></span></button></div>
  <div id="exam1-status-16" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-16');
  ...
  const previous = window.exam1Answers[16];
  if (previous) {
    window.exam1Pick(16, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 16 -->`,
    progress: 52,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q16\s*:\s*[A-D]/i.test(code); }
};