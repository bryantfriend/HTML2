...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(2, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">F5</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(2, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">F9</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(2, 'C', true)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">F12</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(2, 'D', false)"><span class="exam1-badge">D</span><span>Tab</span></button></div>
