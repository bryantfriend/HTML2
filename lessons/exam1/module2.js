window.Lessons.exam1.modules[1] = {
    title: "2. Exam Question 2",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 2 of 30</p>
  <p class="exam1-question">Which key is commonly used in the lessons to open browser developer tools?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(2, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">F12</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(2, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">F5</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(2, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">F9</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(2, 'D', false)"><span class="exam1-badge">D</span><span>Tab</span></button></div>
  <div id="exam1-status-2" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-2');
  ...
  const previous = window.exam1Answers[2];
  if (previous) {
    window.exam1Pick(2, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 2 -->`,
    progress: 6,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q2\s*:\s*[A-D]/i.test(code); }
};