window.Lessons.exam1.modules[19] = {
    title: "20. Exam Question 20",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 20 of 30</p>
  <p class="exam1-question">If students click food buttons into a list, what idea is the activity teaching?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(20, 'A', false)"><span class="exam1-badge">A</span><span>Headings must be underlined</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(20, 'B', false)"><span class="exam1-badge">B</span><span>Videos need autoplay</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(20, 'C', true)"><span class="exam1-badge">C</span><span>List items belong inside a list container</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(20, 'D', false)"><span class="exam1-badge">D</span><span>Images need a width attribute</span></button></div>
  <div id="exam1-status-20" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-20');
  ...
  const previous = window.exam1Answers[20];
  if (previous) {
    window.exam1Pick(20, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 20 -->`,
    progress: 65,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q20\s*:\s*[A-D]/i.test(code); }
};