...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(20, 'A', true)"><span class="exam1-badge">A</span><span>List items belong inside a list container</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(20, 'B', false)"><span class="exam1-badge">B</span><span>Videos need autoplay</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(20, 'C', false)"><span class="exam1-badge">C</span><span>Images need a width attribute</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(20, 'D', false)"><span class="exam1-badge">D</span><span>Headings must be underlined</span></button></div>
