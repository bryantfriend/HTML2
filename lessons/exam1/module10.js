window.Lessons.exam1.modules[9] = {
    title: "10. Exam Question 10",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 10 of 30</p>
  <p class="exam1-question">Which example is nested correctly?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(10, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;p&gt;&lt;strong&gt;Hi&lt;/strong&gt;&lt;/p&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(10, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;p&gt;&lt;strong&gt;Hi&lt;/p&gt;&lt;/strong&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(10, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;strong&gt;&lt;p&gt;Hi&lt;/strong&gt;&lt;/p&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(10, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;p&gt;&lt;/strong&gt;Hi&lt;strong&gt;&lt;/p&gt;</code></span></button></div>
  <div id="exam1-status-10" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-10');
  ...
  const previous = window.exam1Answers[10];
  if (previous) {
    window.exam1Pick(10, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 10 -->`,
    progress: 32,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q10\s*:\s*[A-D]/i.test(code); }
};