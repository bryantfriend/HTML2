window.Lessons.exam1.modules[2] = {
    title: "3. Exam Question 3",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 3 of 30</p>
  <p class="exam1-question">Which file extension is correct for an HTML web page?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(3, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">.html</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(3, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">.jpg</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(3, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">.mp3</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(3, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">.zip</code></span></button></div>
  <div id="exam1-status-3" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-3');
  ...
  const previous = window.exam1Answers[3];
  if (previous) {
    window.exam1Pick(3, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 3 -->`,
    progress: 10,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q3\s*:\s*[A-D]/i.test(code); }
};