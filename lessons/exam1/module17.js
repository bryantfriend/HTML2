window.Lessons.exam1.modules[16] = {
    title: "17. Exam Question 17",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 17 of 30</p>
  <p class="exam1-question">Which tag is used for each item inside a list?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(17, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;point&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(17, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;item&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(17, 'C', true)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;li&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(17, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;entry&gt;</code></span></button></div>
  <div id="exam1-status-17" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-17');
  ...
  const previous = window.exam1Answers[17];
  if (previous) {
    window.exam1Pick(17, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 17 -->`,
    progress: 55,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q17\s*:\s*[A-D]/i.test(code); }
};