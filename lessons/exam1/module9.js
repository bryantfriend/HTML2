...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(9, 'A', false)"><span class="exam1-badge">A</span><span>Deleting old code</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(9, 'B', false)"><span class="exam1-badge">B</span><span>Opening two tabs at once</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(9, 'C', false)"><span class="exam1-badge">C</span><span>Putting files in a folder</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(9, 'D', true)"><span class="exam1-badge">D</span><span>Placing one tag inside another tag</span></button></div>
