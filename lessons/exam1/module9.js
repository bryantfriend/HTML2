window.Lessons.exam1.modules[8] = {
    title: "9. Exam Question 9",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 9 of 30</p>
  <p class="exam1-question">What does nesting mean in HTML?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(9, 'A', true)"><span class="exam1-badge">A</span><span>Placing one tag inside another tag</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(9, 'B', false)"><span class="exam1-badge">B</span><span>Putting files in a folder</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(9, 'C', false)"><span class="exam1-badge">C</span><span>Deleting old code</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(9, 'D', false)"><span class="exam1-badge">D</span><span>Opening two tabs at once</span></button></div>
  <div id="exam1-status-9" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-9');
  ...
  const previous = window.exam1Answers[9];
  if (previous) {
    window.exam1Pick(9, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 9 -->`,
    progress: 29,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q9\s*:\s*[A-D]/i.test(code); }
};