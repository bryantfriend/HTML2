window.Lessons.exam1.modules[22] = {
    title: "23. Exam Question 23",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 23 of 30</p>
  <p class="exam1-question">Why do many examples indent nested HTML?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(23, 'A', false)"><span class="exam1-badge">A</span><span>It automatically fixes mistakes</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(23, 'B', false)"><span class="exam1-badge">B</span><span>It changes the font size</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(23, 'C', false)"><span class="exam1-badge">C</span><span>It uploads the file to the internet</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(23, 'D', true)"><span class="exam1-badge">D</span><span>It makes the structure easier to read</span></button></div>
  <div id="exam1-status-23" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-23');
  ...
  const previous = window.exam1Answers[23];
  if (previous) {
    window.exam1Pick(23, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 23 -->`,
    progress: 74,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q23\s*:\s*[A-D]/i.test(code); }
};