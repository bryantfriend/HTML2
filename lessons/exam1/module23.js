...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(23, 'A', true)"><span class="exam1-badge">A</span><span>It makes the structure easier to read</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(23, 'B', false)"><span class="exam1-badge">B</span><span>It changes the font size</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(23, 'C', false)"><span class="exam1-badge">C</span><span>It uploads the file to the internet</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(23, 'D', false)"><span class="exam1-badge">D</span><span>It automatically fixes mistakes</span></button></div>
