window.Lessons.exam1.modules[6] = {
    title: "7. Exam Question 7",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 7 of 30</p>
  <p class="exam1-question">Which tag is the correct opening tag for the biggest heading?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(7, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;h1&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(7, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;heading1&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(7, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;head1&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(7, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;header&gt;</code></span></button></div>
  <div id="exam1-status-7" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-7');
  ...
  const previous = window.exam1Answers[7];
  if (previous) {
    window.exam1Pick(7, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 7 -->`,
    progress: 23,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q7\s*:\s*[A-D]/i.test(code); }
};