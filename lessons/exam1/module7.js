...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(7, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;h1&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(7, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;head1&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(7, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;header&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(7, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;heading1&gt;</code></span></button></div>
