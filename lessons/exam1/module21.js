window.Lessons.exam1.modules[20] = {
    title: "21. Exam Question 21",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 21 of 30</p>
  <p class="exam1-question">Which tag is best for the main page title?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(21, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;li&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(21, 'B', true)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;h1&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(21, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;ul&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(21, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;p&gt;</code></span></button></div>
  <div id="exam1-status-21" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-21');
  ...
  const previous = window.exam1Answers[21];
  if (previous) {
    window.exam1Pick(21, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 21 -->`,
    progress: 68,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q21\s*:\s*[A-D]/i.test(code); }
};