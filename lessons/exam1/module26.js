window.Lessons.exam1.modules[25] = {
    title: "26. Exam Question 26",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 26 of 30</p>
  <p class="exam1-question">Which example is a correct paragraph element?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(26, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;p&gt;Hello&lt;/h1&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(26, 'B', true)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;p&gt;Hello&lt;/p&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(26, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;p&gt;Hello&lt;p&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(26, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;paragraph&gt;Hello&lt;/paragraph&gt;</code></span></button></div>
  <div id="exam1-status-26" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-26');
  ...
  const previous = window.exam1Answers[26];
  if (previous) {
    window.exam1Pick(26, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 26 -->`,
    progress: 84,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q26\s*:\s*[A-D]/i.test(code); }
};