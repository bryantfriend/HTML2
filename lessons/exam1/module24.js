window.Lessons.exam1.modules[23] = {
    title: "24. Exam Question 24",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 24 of 30</p>
  <p class="exam1-question">What usually happens if tags are closed in the wrong order?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(24, 'A', true)"><span class="exam1-badge">A</span><span>The structure breaks or behaves strangely</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(24, 'B', false)"><span class="exam1-badge">B</span><span>The page turns into a video</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(24, 'C', false)"><span class="exam1-badge">C</span><span>The browser doubles the text size</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(24, 'D', false)"><span class="exam1-badge">D</span><span>The file becomes CSS</span></button></div>
  <div id="exam1-status-24" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-24');
  ...
  const previous = window.exam1Answers[24];
  if (previous) {
    window.exam1Pick(24, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 24 -->`,
    progress: 77,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q24\s*:\s*[A-D]/i.test(code); }
};