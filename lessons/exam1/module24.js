...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(24, 'A', false)"><span class="exam1-badge">A</span><span>The browser doubles the text size</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(24, 'B', true)"><span class="exam1-badge">B</span><span>The structure breaks or behaves strangely</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(24, 'C', false)"><span class="exam1-badge">C</span><span>The page turns into a video</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(24, 'D', false)"><span class="exam1-badge">D</span><span>The file becomes CSS</span></button></div>
