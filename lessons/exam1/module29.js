window.Lessons.exam1.modules[28] = {
    title: "29. Exam Question 29",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 29 of 30</p>
  <p class="exam1-question">If you want three numbered steps, which outer tag should you choose?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(29, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;p&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(29, 'B', true)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;ol&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(29, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;h3&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(29, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;ul&gt;</code></span></button></div>
  <div id="exam1-status-29" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-29');
  ...
  const previous = window.exam1Answers[29];
  if (previous) {
    window.exam1Pick(29, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 29 -->`,
    progress: 94,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q29\s*:\s*[A-D]/i.test(code); }
};