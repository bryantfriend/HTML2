window.Lessons.exam1.modules[10] = {
    title: "11. Exam Question 11",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 11 of 30</p>
  <p class="exam1-question">Which tag creates a paragraph?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(11, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;p&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(11, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;paragraph&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(11, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;text&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(11, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;h3&gt;</code></span></button></div>
  <div id="exam1-status-11" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-11');
  ...
  const previous = window.exam1Answers[11];
  if (previous) {
    window.exam1Pick(11, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 11 -->`,
    progress: 35,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q11\s*:\s*[A-D]/i.test(code); }
};