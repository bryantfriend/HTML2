window.Lessons.exam1.modules[3] = {
    title: "4. Exam Question 4",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 4 of 30</p>
  <p class="exam1-question">Which tag is the outer container for the whole HTML document?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(4, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;body&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(4, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;head&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(4, 'C', true)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;html&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(4, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;title&gt;</code></span></button></div>
  <div id="exam1-status-4" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-4');
  ...
  const previous = window.exam1Answers[4];
  if (previous) {
    window.exam1Pick(4, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 4 -->`,
    progress: 13,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q4\s*:\s*[A-D]/i.test(code); }
};