...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(30, 'A', false)"><span class="exam1-badge">A</span><span>After renaming the file</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(30, 'B', false)"><span class="exam1-badge">B</span><span>After deleting the code</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(30, 'C', false)"><span class="exam1-badge">C</span><span>After closing the browser</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(30, 'D', true)"><span class="exam1-badge">D</span><span>When the next button unlocks</span></button></div>
