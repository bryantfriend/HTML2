window.Lessons.exam1.modules[12] = {
    title: "13. Exam Question 13",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 13 of 30</p>
  <p class="exam1-question">Which tag is used for emphasized or italic text?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(13, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;em&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(13, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;list&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(13, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;src&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(13, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;alt&gt;</code></span></button></div>
  <div id="exam1-status-13" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-13');
  ...
  const previous = window.exam1Answers[13];
  if (previous) {
    window.exam1Pick(13, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 13 -->`,
    progress: 42,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q13\s*:\s*[A-D]/i.test(code); }
};