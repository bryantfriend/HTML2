window.Lessons.exam1.modules[11] = {
    title: "12. Exam Question 12",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 12 of 30</p>
  <p class="exam1-question">Which tag is used to make text strong or bold?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(12, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;strong&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(12, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;img&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(12, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;em&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(12, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;li&gt;</code></span></button></div>
  <div id="exam1-status-12" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-12');
  ...
  const previous = window.exam1Answers[12];
  if (previous) {
    window.exam1Pick(12, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 12 -->`,
    progress: 39,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q12\s*:\s*[A-D]/i.test(code); }
};