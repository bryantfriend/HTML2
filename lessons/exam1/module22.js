...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(22, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;img&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(22, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;ol&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(22, 'C', true)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;h2&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(22, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;body&gt;</code></span></button></div>
