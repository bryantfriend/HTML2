window.Lessons.exam1.modules[21] = {
    title: "22. Exam Question 22",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 22 of 30</p>
  <p class="exam1-question">Which tag is a good choice for a smaller heading under the main title?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(22, 'A', true)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;h2&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(22, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;body&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(22, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;img&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(22, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;ol&gt;</code></span></button></div>
  <div id="exam1-status-22" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-22');
  ...
  const previous = window.exam1Answers[22];
  if (previous) {
    window.exam1Pick(22, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 22 -->`,
    progress: 71,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q22\s*:\s*[A-D]/i.test(code); }
};