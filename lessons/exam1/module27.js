window.Lessons.exam1.modules[26] = {
    title: "27. Exam Question 27",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 27 of 30</p>
  <p class="exam1-question">Which example is a correct list item element?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(27, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;li&gt;Pizza&lt;ul&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(27, 'B', false)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;ul&gt;Pizza&lt;/ul&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(27, 'C', true)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;li&gt;Pizza&lt;/li&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(27, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;item&gt;Pizza&lt;/item&gt;</code></span></button></div>
  <div id="exam1-status-27" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-27');
  ...
  const previous = window.exam1Answers[27];
  if (previous) {
    window.exam1Pick(27, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 27 -->`,
    progress: 87,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q27\s*:\s*[A-D]/i.test(code); }
};