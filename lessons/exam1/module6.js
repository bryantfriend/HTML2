window.Lessons.exam1.modules[5] = {
    title: "6. Exam Question 6",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 6 of 30</p>
  <p class="exam1-question">Which tag holds most of the visible content on the page?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(6, 'A', false)"><span class="exam1-badge">A</span><span><code class="exam1-inline-code">&lt;link&gt;</code></span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(6, 'B', true)"><span class="exam1-badge">B</span><span><code class="exam1-inline-code">&lt;body&gt;</code></span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(6, 'C', false)"><span class="exam1-badge">C</span><span><code class="exam1-inline-code">&lt;head&gt;</code></span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(6, 'D', false)"><span class="exam1-badge">D</span><span><code class="exam1-inline-code">&lt;meta&gt;</code></span></button></div>
  <div id="exam1-status-6" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-6');
  ...
  const previous = window.exam1Answers[6];
  if (previous) {
    window.exam1Pick(6, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 6 -->`,
    progress: 19,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q6\s*:\s*[A-D]/i.test(code); }
};