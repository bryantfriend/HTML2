...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(14, 'A', true)"><span class="exam1-badge">A</span><span>To organize related items</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(14, 'B', false)"><span class="exam1-badge">B</span><span>To play music</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(14, 'C', false)"><span class="exam1-badge">C</span><span>To change file names</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(14, 'D', false)"><span class="exam1-badge">D</span><span>To save browser history</span></button></div>
