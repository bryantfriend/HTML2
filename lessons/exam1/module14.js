window.Lessons.exam1.modules[13] = {
    title: "14. Exam Question 14",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 14 of 30</p>
  <p class="exam1-question">What is the main purpose of a list in HTML?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(14, 'A', false)"><span class="exam1-badge">A</span><span>To change file names</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(14, 'B', true)"><span class="exam1-badge">B</span><span>To organize related items</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(14, 'C', false)"><span class="exam1-badge">C</span><span>To save browser history</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(14, 'D', false)"><span class="exam1-badge">D</span><span>To play music</span></button></div>
  <div id="exam1-status-14" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-14');
  ...
  const previous = window.exam1Answers[14];
  if (previous) {
    window.exam1Pick(14, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 14 -->`,
    progress: 45,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q14\s*:\s*[A-D]/i.test(code); }
};