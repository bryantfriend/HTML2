...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(1, 'A', false)"><span class="exam1-badge">A</span><span>High Transfer Machine Language</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(1, 'B', false)"><span class="exam1-badge">B</span><span>Hyperlink Text Machine Logic</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(1, 'C', false)"><span class="exam1-badge">C</span><span>Home Tool Markup Logic</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(1, 'D', true)"><span class="exam1-badge">D</span><span>HyperText Markup Language</span></button></div>
