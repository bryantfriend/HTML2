window.Lessons.exam1.modules[0] = {
    title: "1. Exam Question 1",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 1 of 30</p>
  <p class="exam1-question">What does HTML stand for?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(1, 'A', true)"><span class="exam1-badge">A</span><span>HyperText Markup Language</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(1, 'B', false)"><span class="exam1-badge">B</span><span>High Transfer Machine Language</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(1, 'C', false)"><span class="exam1-badge">C</span><span>Home Tool Markup Logic</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(1, 'D', false)"><span class="exam1-badge">D</span><span>Hyperlink Text Machine Logic</span></button></div>
  <div id="exam1-status-1" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-1');
  ...
  const previous = window.exam1Answers[1];
  if (previous) {
    window.exam1Pick(1, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 1 -->`,
    progress: 3,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q1\s*:\s*[A-D]/i.test(code); }
};