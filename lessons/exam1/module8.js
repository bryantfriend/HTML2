...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(8, 'A', false)"><span class="exam1-badge">A</span><span>So buttons appear automatically</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(8, 'B', false)"><span class="exam1-badge">B</span><span>So the file becomes shorter</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(8, 'C', false)"><span class="exam1-badge">C</span><span>So images load faster</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(8, 'D', true)"><span class="exam1-badge">D</span><span>So the browser can read the structure correctly</span></button></div>
