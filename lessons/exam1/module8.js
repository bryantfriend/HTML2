window.Lessons.exam1.modules[7] = {
    title: "8. Exam Question 8",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 8 of 30</p>
  <p class="exam1-question">Why do opening and closing tags need to match?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(8, 'A', true)"><span class="exam1-badge">A</span><span>So the browser can read the structure correctly</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(8, 'B', false)"><span class="exam1-badge">B</span><span>So the file becomes shorter</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(8, 'C', false)"><span class="exam1-badge">C</span><span>So images load faster</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(8, 'D', false)"><span class="exam1-badge">D</span><span>So buttons appear automatically</span></button></div>
  <div id="exam1-status-8" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-8');
  ...
  const previous = window.exam1Answers[8];
  if (previous) {
    window.exam1Pick(8, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 8 -->`,
    progress: 26,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q8\s*:\s*[A-D]/i.test(code); }
};