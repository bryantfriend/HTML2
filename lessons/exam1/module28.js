window.Lessons.exam1.modules[27] = {
    title: "28. Exam Question 28",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 28 of 30</p>
  <p class="exam1-question">What is a nested list?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(28, 'A', true)"><span class="exam1-badge">A</span><span>A list placed inside a list item</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(28, 'B', false)"><span class="exam1-badge">B</span><span>A list with no closing tags</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(28, 'C', false)"><span class="exam1-badge">C</span><span>A heading inside the &lt;head&gt;</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(28, 'D', false)"><span class="exam1-badge">D</span><span>A paragraph with bullet points</span></button></div>
  <div id="exam1-status-28" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-28');
  ...
  const previous = window.exam1Answers[28];
  if (previous) {
    window.exam1Pick(28, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 28 -->`,
    progress: 90,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q28\s*:\s*[A-D]/i.test(code); }
};