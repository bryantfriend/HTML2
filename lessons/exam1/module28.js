...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(28, 'A', false)"><span class="exam1-badge">A</span><span>A paragraph with bullet points</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(28, 'B', true)"><span class="exam1-badge">B</span><span>A list placed inside a list item</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(28, 'C', false)"><span class="exam1-badge">C</span><span>A heading inside the &lt;head&gt;</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(28, 'D', false)"><span class="exam1-badge">D</span><span>A list with no closing tags</span></button></div>
