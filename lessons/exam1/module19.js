window.Lessons.exam1.modules[18] = {
    title: "19. Exam Question 19",
...
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-19');
  ...
  const previous = window.exam1Answers[19];
  if (previous) {
    window.exam1Pick(19, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 19 -->`,
    progress: 61,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q19\s*:\s*[A-D]/i.test(code); }
};