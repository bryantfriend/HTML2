window.Lessons.exam1.modules[24] = {
    title: "25. Exam Question 25",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 25 of 30</p>
  <p class="exam1-question">Why is clean, readable HTML useful?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(25, 'A', true)"><span class="exam1-badge">A</span><span>It is easier to understand and fix later</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(25, 'B', false)"><span class="exam1-badge">B</span><span>It makes every page animated</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(25, 'C', false)"><span class="exam1-badge">C</span><span>It removes the need for closing tags</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(25, 'D', false)"><span class="exam1-badge">D</span><span>It changes bullet lists into numbered lists</span></button></div>
  <div id="exam1-status-25" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-25');
  ...
  const previous = window.exam1Answers[25];
  if (previous) {
    window.exam1Pick(25, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 25 -->`,
    progress: 81,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q25\s*:\s*[A-D]/i.test(code); }
};