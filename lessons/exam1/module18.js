window.Lessons.exam1.modules[17] = {
    title: "18. Exam Question 18",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 18 of 30</p>
  <p class="exam1-question">Which type of list uses bullet points by default?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(18, 'A', true)"><span class="exam1-badge">A</span><span>Unordered list</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(18, 'B', false)"><span class="exam1-badge">B</span><span>Ordered list</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(18, 'C', false)"><span class="exam1-badge">C</span><span>Numbered heading</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(18, 'D', false)"><span class="exam1-badge">D</span><span>Nested paragraph</span></button></div>
  <div id="exam1-status-18" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-18');
  ...
  const previous = window.exam1Answers[18];
  if (previous) {
    window.exam1Pick(18, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 18 -->`,
    progress: 58,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q18\s*:\s*[A-D]/i.test(code); }
};