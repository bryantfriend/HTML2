window.Lessons.exam1.modules[4] = {
    title: "5. Exam Question 5",
...
<div class="exam1-shell">
  <p class="exam1-kicker">Exam 1 Question 5 of 30</p>
  <p class="exam1-question">Which part of the page belongs inside the &lt;head&gt; section?</p>
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(5, 'A', true)"><span class="exam1-badge">A</span><span>The page title</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(5, 'B', false)"><span class="exam1-badge">B</span><span>The main paragraph text</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(5, 'C', false)"><span class="exam1-badge">C</span><span>The list items students can see</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(5, 'D', false)"><span class="exam1-badge">D</span><span>The image shown in the body</span></button></div>
  <div id="exam1-status-5" class="exam1-status">Choose the best answer.</div>
</div>
<script>
(function() {
  ...
  window.exam1Pick = function(questionNumber, choice, isCorrect) {
    ...
    const status = document.getElementById('exam1-status-5');
  ...
  const previous = window.exam1Answers[5];
  if (previous) {
    window.exam1Pick(5, previous.selected, previous.correct);
  }
})();
</script>`,
    initialCode: `<!-- Pick the best answer for Question 5 -->`,
    progress: 16,
    validator: function(code) { return /EXAM1_ANSWER\s*:\s*Q5\s*:\s*[A-D]/i.test(code); }
};