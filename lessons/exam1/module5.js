...
<div class="exam1-shell">
  ...
  <div class="exam1-options"><button type="button" class="exam1-option" data-choice="A" onclick="window.exam1Pick(5, 'A', false)"><span class="exam1-badge">A</span><span>The image shown in the body</span></button><button type="button" class="exam1-option" data-choice="B" onclick="window.exam1Pick(5, 'B', false)"><span class="exam1-badge">B</span><span>The main paragraph text</span></button><button type="button" class="exam1-option" data-choice="C" onclick="window.exam1Pick(5, 'C', true)"><span class="exam1-badge">C</span><span>The page title</span></button><button type="button" class="exam1-option" data-choice="D" onclick="window.exam1Pick(5, 'D', false)"><span class="exam1-badge">D</span><span>The list items students can see</span></button></div>
