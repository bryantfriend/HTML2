...
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      ...
      <p class="lesson-demo-heading">Switching the file extension changes the kind of media you show.</p>
    </div>
    <span class="lesson-demo-chip">file types</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module11">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">format-switch.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="https://media.giphy.com/media/JIX9t2j0ZTN9S/giphy.gif" alt="Dancing cat"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-badges"><span class="lesson-demo-badge">.jpg photo</span><span class="lesson-demo-badge">.png transparent</span><span class="lesson-demo-badge">.gif animated</span></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. File endings matter.</div><div class="lesson-demo-caption">2. GIF files can be animated.</div><div class="lesson-demo-caption">3. Swap the source to try a new format.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Swap</p><p class="lesson-demo-tip-copy">Change the source file name.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Try GIF</p><p class="lesson-demo-tip-copy">Use dance.gif for this mission.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Remember</p><p class="lesson-demo-tip-copy">Extensions tell the browser the format.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
