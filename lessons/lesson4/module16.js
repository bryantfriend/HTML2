window.Lessons.lesson4.modules[15] = {
    title: "16. Video time!",
    body: `<p>Video tags work like audio tags, but now the page can show moving pictures too, and the module should feel more alive.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">Video needs opening and closing tags just like audio, and this demo uses a real clip.</p>
    </div>
    <span class="lesson-demo-chip">video start</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module16">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">video-intro.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;video&gt;
&lt;/video&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-video-player"><video src="https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4" muted loop autoplay playsinline style="width:100%;display:block"></video></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Open the video tag.</div><div class="lesson-demo-caption">2. Close the video tag.</div><div class="lesson-demo-caption">3. This creates the video container.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Match</p><p class="lesson-demo-tip-copy">Use both opening and closing tags.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Mirror</p><p class="lesson-demo-tip-copy">Video behaves like audio here.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Prepare</p><p class="lesson-demo-tip-copy">Source and controls come next.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Type <code>&lt;video&gt;</code> and <code>&lt;/video&gt;</code> so the page gets ready for real moving media.</p>`,
