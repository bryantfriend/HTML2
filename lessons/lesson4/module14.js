window.Lessons.lesson4.modules[13] = {
    ...
    body: `<p>The audio tag also needs directions. Once the student adds the source, the player should wake up with a real beat.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">The player needs a music file before it can play anything fun.</p>
    </div>
    <span class="lesson-demo-chip">sound path</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module14">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">audio-source.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;audio src="music.mp3"&gt;
&lt;/audio&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-player"><div class="lesson-demo-badges"><span class="lesson-demo-badge">music.mp3</span><span class="lesson-demo-badge">source loaded</span></div></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Add the source in the opening audio tag.</div><div class="lesson-demo-caption">2. Put the file name in quotes.</div><div class="lesson-demo-caption">3. Now the player knows what to play.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Point it</p><p class="lesson-demo-tip-copy">Set the audio file name with src.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Quote it</p><p class="lesson-demo-tip-copy">Keep the value in quotes.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Use</p><p class="lesson-demo-tip-copy">For this mission, type music.mp3.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
