...
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      ...
      <p class="lesson-demo-heading">A full image tag creates a real photo moment.</p>
    </div>
    <span class="lesson-demo-chip">full tag</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module4">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">cat-card.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="assets/cat-demo.svg" alt="Happy cat"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
      ...
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Open the image tag.</div><div class="lesson-demo-caption">2. Add a source and a short description.</div><div class="lesson-demo-caption">3. The cat pops into the page.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Assemble</p><p class="lesson-demo-tip-copy">Use one complete image tag.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Describe</p><p class="lesson-demo-tip-copy">Give the cat helpful alt text.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Win</p><p class="lesson-demo-tip-copy">A complete image tag unlocks the mission.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
