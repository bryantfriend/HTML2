window.Lessons.lesson4.modules[14] = {
    ...
    body: `<p>Without controls, the audio player is invisible. This boolean attribute makes the buttons appear.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">Controls reveal the play bar, button, and timeline.</p>
    </div>
    <span class="lesson-demo-chip">show controls</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module15">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">audio-controls.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;audio src="music.mp3" controls&gt;
&lt;/audio&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-player"><div class="lesson-demo-audio-bar"><div class="lesson-demo-play">&#9654;</div><div class="lesson-demo-track"></div><span class="lesson-demo-badge">controls</span></div></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Add the word <code>controls</code>.</div><div class="lesson-demo-caption">2. No equals sign is needed here.</div><div class="lesson-demo-caption">3. The player buttons become visible.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Boolean</p><p class="lesson-demo-tip-copy">This attribute is just one word.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Visible</p><p class="lesson-demo-tip-copy">Controls make the player usable.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Add it</p><p class="lesson-demo-tip-copy">Place it in the opening tag.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Add <code>controls</code> inside the opening <code>&lt;audio&gt;</code> tag so the polished player appears.</p>`,
