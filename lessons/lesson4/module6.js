window.Lessons.lesson4.modules[5] = {
    ...
    body: `<p>Great websites still communicate even when the picture is missing. Alt gives the image a backup description.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">Alt text tells people what the picture is meant to show.</p>
    </div>
    <span class="lesson-demo-chip">accessibility</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module6">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">friendly-alt.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="cat.jpg" alt="A cute cat"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-altcard">A cute cat</div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Add the <code>alt</code> attribute to the tag.</div><div class="lesson-demo-caption">2. Write a short, helpful description.</div><div class="lesson-demo-caption">3. Screen readers and broken images both benefit.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Support</p><p class="lesson-demo-tip-copy">Alt text helps every visitor.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Describe</p><p class="lesson-demo-tip-copy">Keep the words short and clear.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Add it</p><p class="lesson-demo-tip-copy">Your mission unlocks when alt is included.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Add <code>alt="A cute cat"</code> to the image tag.</p>`,
