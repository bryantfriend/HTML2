window.Lessons.lesson4.modules[12] = {
    ...
    body: `<p>Media is not only pictures. Audio tags can play music, voices, and effects.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">Audio tags use both an opening and a closing tag.</p>
    </div>
    <span class="lesson-demo-chip">sound on</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module13">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">audio-intro.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;audio&gt;
&lt;/audio&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-player"><div class="lesson-demo-wave"><span></span><span></span><span></span><span></span><span></span></div><audio controls src="assets/media-master-tone.wav" style="width:100%;margin-top:10px"></audio></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Audio needs an opening tag.</div><div class="lesson-demo-caption">2. Audio also needs a closing tag.</div><div class="lesson-demo-caption">3. This one wraps the media player.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Open</p><p class="lesson-demo-tip-copy">Type the opening audio tag.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Close</p><p class="lesson-demo-tip-copy">Add the closing tag too.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Wrap</p><p class="lesson-demo-tip-copy">Audio is not self-closing here.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Type <code>&lt;audio&gt;</code> and <code>&lt;/audio&gt;</code> below the sound button so the page has a real audio section.</p>`,
