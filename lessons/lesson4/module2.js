window.Lessons.lesson4.modules[1] = {
    title: "2. The <img> Tag",
    body: `<p>This is the moment students learn the shape of the image tag. Keep it short, visual, and easy to copy.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">The browser only needs the opening image tag.</p>
    </div>
    <span class="lesson-demo-chip">tag shape</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module2">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">poster-board.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-badges"><span class="lesson-demo-badge">self-closing</span><span class="lesson-demo-badge">no end tag</span><span class="lesson-demo-badge">quick insert</span></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Start with the tag name.</div><div class="lesson-demo-caption">2. There is no closing &lt;/img&gt; tag here.</div><div class="lesson-demo-caption">3. It is a tiny doorway for pictures.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Spot it</p><p class="lesson-demo-tip-copy">Focus on the exact tag shape.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Copy</p><p class="lesson-demo-tip-copy">Type the image tag on its own.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Remember</p><p class="lesson-demo-tip-copy">No closing tag is needed.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Type exactly <code>&lt;img&gt;</code>.</p>`,
