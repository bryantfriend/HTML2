...
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      ...
      <p class="lesson-demo-heading">Watch how one image tag turns into a real picture.</p>
    </div>
    <span class="lesson-demo-chip">image start</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module1">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">my-gallery.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="assets/cat-demo.svg" alt="Sleepy cat"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
      ...
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. We type an &lt;img&gt; tag.</div><div class="lesson-demo-caption">2. The browser finds the picture with <code>src</code>.</div><div class="lesson-demo-caption">3. One image makes the page feel alive.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Watch</p><p class="lesson-demo-tip-copy">See the tag become a picture.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Type</p><p class="lesson-demo-tip-copy">Enter a simple image tag in the editor.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Unlock</p><p class="lesson-demo-tip-copy">The mission clears as soon as your tag appears.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
