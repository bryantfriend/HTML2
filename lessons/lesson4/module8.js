window.Lessons.lesson4.modules[7] = {
    ...
    body: `<p>Images need sizing too. Width lets you choose how wide the picture should appear.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">Width shrinks or expands the image across the page.</p>
    </div>
    <span class="lesson-demo-chip">size control</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module8">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">width-demo.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="cat.jpg" width="100"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-resize"><div class="lesson-demo-size-box medium" data-size="default"></div><div class="lesson-demo-size-box small" data-size="100px"></div></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Add the width attribute in pixels.</div><div class="lesson-demo-caption">2. Smaller width means a smaller picture.</div><div class="lesson-demo-caption">3. The browser scales it for you.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Resize</p><p class="lesson-demo-tip-copy">Use width to control the image size.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Pixel count</p><p class="lesson-demo-tip-copy">Set it to 100 for this task.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Unlock</p><p class="lesson-demo-tip-copy">The mission checks for width=100 while the slider lets you experiment.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Add <code>width="100"</code> to the image tag.</p>`,
