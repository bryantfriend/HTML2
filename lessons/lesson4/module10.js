window.Lessons.lesson4.modules[9] = {
    ...
    body: `<p>Here is the silly version. Give the image a huge width and tiny height to see how stretching works.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">Mismatched width and height can squish the image.</p>
    </div>
    <span class="lesson-demo-chip">fun distortion</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module10">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">squish-lab.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="cat.jpg" width="500" height="50"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-resize"><div class="lesson-demo-size-box medium" data-size="200x200"></div><div class="lesson-demo-size-box squish" data-size="500x50"></div></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Use a very wide width.</div><div class="lesson-demo-caption">2. Pair it with a tiny height.</div><div class="lesson-demo-caption">3. The cat gets hilariously squished.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Play</p><p class="lesson-demo-tip-copy">This mission is meant to look weird.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Match</p><p class="lesson-demo-tip-copy">Set both width and height exactly.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Observe</p><p class="lesson-demo-tip-copy">Stretching changes the image proportions.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Use both sliders, then set the challenge image to <code>width="500"</code> and <code>height="50"</code>.</p>`,
