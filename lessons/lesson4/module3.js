window.Lessons.lesson4.modules[2] = {
    ...
    body: `<p>Now the tag needs directions. Src tells the browser which picture to show, so this mission should end with a real cat in the output.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">The source points the image tag to the file.</p>
    </div>
    <span class="lesson-demo-chip">find file</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module3">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">photo-path.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="assets/cat-demo.svg" alt="Cat"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-photo"><div class="lesson-demo-sun"></div><div class="lesson-demo-cat"><span class="lesson-demo-ear left"></span><span class="lesson-demo-ear right"></span><span class="lesson-demo-face"></span><span class="lesson-demo-face-smile"></span></div></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Add the <code>src</code> attribute inside the tag.</div><div class="lesson-demo-caption">2. Put the file name in quotes.</div><div class="lesson-demo-caption">3. The browser knows which image to load.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Find</p><p class="lesson-demo-tip-copy">Tell the browser the file name.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Quote it</p><p class="lesson-demo-tip-copy">Wrap the file name in quotes.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Test</p><p class="lesson-demo-tip-copy">Your mission unlocks when src is present.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Add <code>src="assets/cat-demo.svg"</code> to the challenge image so the output shows the cat.</p>`,
