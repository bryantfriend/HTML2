...
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      ...
      <p class="lesson-demo-heading">A polished page can mix multiple media types together, one green check at a time.</p>
    </div>
    <span class="lesson-demo-chip">final build</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module20">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">media-portfolio.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;h2&gt;Image&lt;/h2&gt;
&lt;img ...&gt;
&lt;h2&gt;Audio&lt;/h2&gt;
&lt;audio ...&gt;&lt;/audio&gt;
&lt;h2&gt;Video&lt;/h2&gt;
&lt;video ...&gt;&lt;/video&gt;</pre>
        ...
        <div class="lesson-demo-panel">
          ...
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-portfolio"><div class="lesson-demo-section"><h4>Image</h4><div class="lesson-demo-badges"><span class="lesson-demo-badge">&lt;img&gt;</span></div></div><div class="lesson-demo-section"><h4>Audio</h4><div class="lesson-demo-badges"><span class="lesson-demo-badge">&lt;audio&gt;</span></div></div><div class="lesson-demo-section"><h4>Video</h4><div class="lesson-demo-badges"><span class="lesson-demo-badge">&lt;video&gt;</span></div></div></div></div>
        </div>
      </div>
