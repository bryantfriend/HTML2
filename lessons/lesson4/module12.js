window.Lessons.lesson4.modules[11] = {
    ...
    body: `<p>This is the full image recipe: source, alt text, and size working together, and now the checklist turns green as each part is completed.
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      <p class="lesson-demo-eyebrow">Quick Demo</p>
      <p class="lesson-demo-heading">Build the full image tag piece by piece and watch the checklist light up.</p>
    </div>
    <span class="lesson-demo-chip">full combo</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module12">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">hero-image.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;img src="assets/cat-demo.svg" alt="Space cat" width="180"&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-badges"><span class="lesson-demo-badge">src</span><span class="lesson-demo-badge">alt</span><span class="lesson-demo-badge">width</span></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Start with the image tag.</div><div class="lesson-demo-caption">2. Add source, alt text, and width.</div><div class="lesson-demo-caption">3. That creates a stronger final result.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Combine</p><p class="lesson-demo-tip-copy">Use all three pieces together.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Build</p><p class="lesson-demo-tip-copy">A complete tag is the goal.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Clear</p><p class="lesson-demo-tip-copy">Each instruction turns green when the matching attribute appears.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
    <p class="text-sm italic text-gray-400 mt-4">Mission: Create an image tag with <code>src</code>, <code>alt</code>, and <code>width</code>.</p>`,
