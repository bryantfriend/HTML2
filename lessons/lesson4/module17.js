...
<div class="lesson-demo-shell">
  <div class="lesson-demo-shell-header">
    <div>
      ...
      <p class="lesson-demo-heading">The video tag needs both a source and controls to feel complete.</p>
    </div>
    <span class="lesson-demo-chip">ready to play</span>
  </div>
  <div class="lesson-demo-shell-body">
    <div class="lesson-demo-video" data-demo-video="lesson4-module17">
      <div class="lesson-demo-browser">
        <div class="lesson-demo-dots"><span></span><span></span><span></span></div>
        <div class="lesson-demo-address">movie-player.html</div>
      </div>
      <div class="lesson-demo-grid">
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Code</p>
          <pre class="lesson-demo-snippet">&lt;video src="movie.mp4" controls&gt;
&lt;/video&gt;</pre>
        </div>
        <div class="lesson-demo-panel">
          <p class="lesson-demo-label">Preview</p>
          <div class="lesson-demo-preview-frame"><div class="lesson-demo-video-player"><div class="lesson-demo-screen"><div class="lesson-demo-clapper"></div></div><div class="lesson-demo-controls"><div class="lesson-demo-play">&#9654;</div><div class="lesson-demo-track"></div><span class="lesson-demo-badge">movie.mp4</span></div></div></div>
        </div>
      </div>
      <div class="lesson-demo-captions"><div class="lesson-demo-caption active">1. Add the video file with <code>src</code>.</div><div class="lesson-demo-caption">2. Add <code>controls</code> so people can use it.</div><div class="lesson-demo-caption">3. The player is now ready.</div></div>
      <div class="lesson-demo-footer"><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Two parts</p><p class="lesson-demo-tip-copy">Use both src and controls.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Place them</p><p class="lesson-demo-tip-copy">Both belong in the opening tag.</p></div><div class="lesson-demo-tip"><p class="lesson-demo-tip-title">Check</p><p class="lesson-demo-tip-copy">The mission unlocks when both appear.</p></div><button type="button" class="lesson-demo-replay">Replay demo</button></div>
    </div>
  </div>
</div></p>
