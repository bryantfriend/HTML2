window.Lessons.lesson5.modules[4] = {
    ...
    <h3 class="quest-title">5. Password Inputs</h3>
    <p class="quest-summary">Passwords should hide the letters so other people cannot read them easily.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">See how the password box hides the letters with dots.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Compare the text box and the secret box.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Change the input to <code>type="password"</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Password inputs hide the characters as you type.</div>
    <p class="quest-mission">Mission: Change the input to a password input.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-secret-mode" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-secret-mode)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="194" height="14" rx="7" fill="url(#form-glow-secret-mode)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Secret mode</text>
  </svg></div>
<div class="quest-widget-shell quest-toggle-shell" data-quest-toggle="true" data-marker="">
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Text input vs password input</h4>
      </div>
      <span class="quest-chip">compare</span>
    </div>
    <div class="quest-toggle-tabs">
      <button type="button" class="quest-toggle-btn is-active" data-target="lesson5-5-panel-0">Text</button><button type="button" class="quest-toggle-btn" data-target="lesson5-5-panel-1">Password</button>
    </div>
    <div class="quest-toggle-panels">
      <div class="quest-toggle-panel is-active" id="lesson5-5-panel-0"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="display:grid;gap:6px;margin-bottom:10px;"><div style="font:700 12px/1.2 sans-serif;color:#0f172a;letter-spacing:0.04em;">Password</div><div style="padding:10px 12px;border-radius:12px;background:white;border:1px solid #93c5fd;color:#475569;font:600 13px/1.2 sans-serif;">dragon123</div></div></div></div><div class="quest-toggle-panel" id="lesson5-5-panel-1"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="display:grid;gap:6px;margin-bottom:10px;"><div style="font:700 12px/1.2 sans-serif;color:#0f172a;letter-spacing:0.04em;">Password</div><div style="padding:10px 12px;border-radius:12px;background:white;border:1px solid #93c5fd;color:#475569;font:600 13px/1.2 sans-serif;">........</div></div></div></div>
    </div>
    <p class="quest-status">Tap each tab, then type the password version in the editor.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 25,
    validator: function(code) { return new RegExp("<\\s*input\\b[^>]*\\btype\\s*=\\s*(?:['\"]password['\"]|password)", 'i').test(code); }
};