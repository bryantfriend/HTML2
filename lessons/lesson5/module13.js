window.Lessons.lesson5.modules[12] = {
    ...
    <h3 class="quest-title">13. Textarea for Big Messages</h3>
    <p class="quest-summary">When people need to type a longer message, use <code>&lt;textarea&gt;</code>.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">The message box is taller than a single input.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Compare the small field and the bigger message box.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>&lt;textarea&gt;&lt;/textarea&gt;</code> inside the form.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Textarea uses an opening tag and a closing tag.</div>
    <p class="quest-mission">Mission: Replace the input with a textarea.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-big-message-box" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-big-message-box)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="176" height="14" rx="7" fill="url(#form-glow-big-message-box)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Big message box</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Textarea gives the user room to write.</h4>
      </div>
      <span class="quest-chip">message box</span>
    </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 65,
    validator: function(code) { return /<\s*textarea\b/i.test(code) && /<\s*\/\s*textarea\s*>/i.test(code); }
};