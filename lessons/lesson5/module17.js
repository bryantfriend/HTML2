window.Lessons.lesson5.modules[16] = {
    ...
    <h3 class="quest-title">17. Action = Where It Goes</h3>
    <p class="quest-summary">The <code>action</code> attribute tells the form where to send the data.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Think of action like the delivery address for the form.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Read the path carefully before you type it.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>action="/login"</code> to the form tag.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Action is the destination.</div>
    <p class="quest-mission">Mission: Tell the form where to send the data.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-delivery-path" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-delivery-path)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="152" height="14" rx="7" fill="url(#form-glow-delivery-path)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Delivery path</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">action points to the destination.</h4>
      </div>
      <span class="quest-chip">destination</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      <div class="quest-browser">
        ...
        <div class="quest-browser-bar">form-route.html</div>
      </div>
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Code</p>
          <pre class="quest-demo-snippet">&lt;form action="/login"&gt;</pre>
        </div>
        <div class="quest-demo-panel">
          <p class="quest-panel-label">Preview</p>
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="display:grid;gap:10px;color:#0f172a;font:700 13px/1.4 sans-serif;"><div style="padding:12px;border-radius:14px;background:white;border:1px solid #bfdbfe;">Form packet ready</div><div style="padding:12px;border-radius:14px;background:#dbeafe;border:1px dashed #60a5fa;">Destination: /login</div></div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">The form packet gets ready.</p><p class="quest-caption">The action points to /login.</p><p class="quest-caption">Now type that same destination in the form tag.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 85,
    validator: function(code) { return new RegExp("<\\s*form\\b[^>]*\\baction\\s*=\\s*(?:['\"]/login['\"]|/login)", 'i').test(code); }
};