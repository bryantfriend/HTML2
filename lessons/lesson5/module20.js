window.Lessons.lesson5.modules[19] = {
    ...
    <h3 class="quest-title">20. Contact Form Final Build</h3>
    <p class="quest-summary">Final mission: build a simple contact form that looks ready for a real website.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Study the full example, then build your own version.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Use the checklist in your head: form, name field, message box, button.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Create a form with a label, an input, a textarea, and a button.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Strong forms are clear, organized, and easy to use.</div>
    <p class="quest-mission">Mission: Build the full contact form challenge.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-final-build" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-final-build)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="244" height="14" rx="7" fill="url(#form-glow-final-build)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Final build</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">A strong form has clear fields and a send button.</h4>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 100,
    validator: function(code) { return /<\s*form\b/i.test(code) && /<\s*label\b/i.test(code) && /<\s*input\b/i.test(code) && /<\s*textarea\b/i.test(code) && /<\s*button\b/i.test(code); }
};