window.Lessons.lesson5.modules[18] = {
    ...
    <h3 class="quest-title">19. Wrap Fields in Divs</h3>
    <p class="quest-summary">A <code>&lt;div&gt;</code> can wrap one label and one input so the form layout stays neat.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Each field group gets its own container.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Think of each div like one row in the form.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Wrap the label and input in a <code>&lt;div&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Div is a layout helper box.</div>
    <p class="quest-mission">Mission: Put the label and input inside one div.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-neat-rows" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-neat-rows)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="214" height="14" rx="7" fill="url(#form-glow-neat-rows)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Neat rows</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Divs group related form pieces.</h4>
      </div>
      <span class="quest-chip">layout helper</span>
    </div>
...
&lt;/div&gt;</pre>
        ...
        <div class="quest-demo-panel">
          ...
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="padding:12px;border-radius:14px;background:white;border:1px solid #bfdbfe;"><div style="display:grid;gap:6px;margin-bottom:10px;"><div style="font:700 12px/1.2 sans-serif;color:#0f172a;letter-spacing:0.04em;">Name</div><div style="padding:10px 12px;border-radius:12px;background:white;border:1px solid #93c5fd;color:#475569;font:600 13px/1.2 sans-serif;">player_one</div></div></div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">The div opens around the group.</p><p class="quest-caption">The label and input live inside it.</p><p class="quest-caption">Now wrap your field in a div.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 95,
    validator: function(code) { return /<\s*div\b/i.test(code) && /<\s*\/\s*div\s*>/i.test(code); }
};