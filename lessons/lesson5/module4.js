window.Lessons.lesson5.modules[3] = {
    ...
    <h3 class="quest-title">4. Text Inputs</h3>
    <p class="quest-summary">The most common input is a text box. We tell the browser with <code>type="text"</code>.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Notice the input becomes a normal typing box.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Compare the code to the preview.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>type="text"</code> to the input.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Type tells the browser what kind of control to build.</div>
    <p class="quest-mission">Mission: Add <code>type="text"</code> to your input.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-text-box" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-text-box)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="214" height="14" rx="7" fill="url(#form-glow-text-box)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Text box</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">type="text" means a normal typing box.</h4>
      </div>
      <span class="quest-chip">attribute</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      ...
      <div class="quest-demo-grid">
        <div class="quest-demo-panel">
          ...
          <pre class="quest-demo-snippet">&lt;input type="text"&gt;</pre>
        </div>
        <div class="quest-demo-panel">
      ...
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Start with an input.</p><p class="quest-caption">Add type="text".</p><p class="quest-caption">Now the browser knows to make a text box.</p>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 20,
    validator: function(code) { return new RegExp("<\\s*input\\b[^>]*\\btype\\s*=\\s*(?:['\"]text['\"]|text)", 'i').test(code); }
};