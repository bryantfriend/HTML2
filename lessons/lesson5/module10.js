window.Lessons.lesson5.modules[9] = {
    ...
    <div class="quest-step-grid">
      ...
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Check that the matching words are the same on both parts.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>for="user"</code> and <code>id="user"</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> The matching words must be identical.</div>
    <p class="quest-mission">Mission: Link the label to the input with matching names.</p>
  </section>`,
    svg: ``,
