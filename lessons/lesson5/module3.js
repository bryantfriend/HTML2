window.Lessons.lesson5.modules[2] = {
    ...
    <h3 class="quest-title">3. Your First Input</h3>
    <p class="quest-summary">An <code>&lt;input&gt;</code> tag makes a box where a person can type.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">See how the input appears inside the form.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Point at the spot where the user will type.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add one <code>&lt;input&gt;</code> inside the form.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Input is a single tag. It does not need a closing tag.</div>
    <p class="quest-mission">Mission: Add an <code>&lt;input&gt;</code> inside the form.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-add-an-input" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-add-an-input)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="208" height="14" rx="7" fill="url(#form-glow-add-an-input)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Add an input</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">Inputs are where answers go.</h4>
      </div>
      <span class="quest-chip">single tag</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      <div class="quest-browser">
        ...
        <div class="quest-browser-bar">name-form.html</div>
      </div>
...
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 15,
    validator: function(code) { return /<\s*form\b/i.test(code) && /<\s*\/\s*form\s*>/i.test(code) && /<\s*input\b/i.test(code); }
};