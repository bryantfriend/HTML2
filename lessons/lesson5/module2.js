window.Lessons.lesson5.modules[1] = {
    ...
    <h3 class="quest-title">2. The Form Tag</h3>
    <p class="quest-summary">The <code>&lt;form&gt;</code> tag is the box that holds the whole data-collecting mission.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Replay the demo and notice the form opens and closes around everything.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Say the rule out loud: form tags come in a pair.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Type <code>&lt;form&gt;&lt;/form&gt;</code> in the editor.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Opening tag first. Closing tag second.</div>
    <p class="quest-mission">Mission: Create opening and closing <code>&lt;form&gt;</code> tags.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-open-the-form" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-open-the-form)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="132" height="14" rx="7" fill="url(#form-glow-open-the-form)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Open the form</text>
  </svg></div>
<div class="quest-widget-shell">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Quick Demo</p>
        <h4 class="quest-widget-title">One form box holds the controls.</h4>
      </div>
      <span class="quest-chip">tag pair</span>
    </div>
    <div class="quest-demo" data-quest-demo="true">
      <div class="quest-browser">
        ...
        <div class="quest-browser-bar">login-lab.html</div>
      </div>
...
&lt;/form&gt;</pre>
        ...
        <div class="quest-demo-panel">
          ...
          <div class="quest-demo-preview"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="padding:22px;border-radius:16px;border:2px dashed #7dd3fc;color:#0f172a;font:800 13px/1.4 sans-serif;text-align:center;">Everything inside here belongs to one form.</div></div></div>
        </div>
      </div>
      <div class="quest-caption-stack">
        <p class="quest-caption is-active">Step 1: open the form.</p><p class="quest-caption">Step 2: close the form.</p><p class="quest-caption">Now type the same tag pair in the editor.</p>
      </div>
