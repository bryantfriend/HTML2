window.Lessons.lesson5.modules[11] = {
    ...
    <h3 class="quest-title">12. Submit Button Type</h3>
    <p class="quest-summary">Inside a form, the main button should use <code>type="submit"</code> so the browser knows its job.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">This type tells the browser to send the form.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Tap the button job that matches sending a form.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>type="submit"</code> to the button.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Submit means send the form data.</div>
    <p class="quest-mission">Mission: Make the button a submit button.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-send-the-form" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-send-the-form)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="192" height="14" rx="7" fill="url(#form-glow-send-the-form)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Send the form</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="SUBMIT_READY"
      data-success="Correct. submit sends the form."
    ...
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Pick the button type that sends the form.</h4>
      </div>
      <span class="quest-chip">one answer</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Which button type should you use here?</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="submit"><span>submit</span><small>Sends the form data.</small></button><button type="button" class="quest-choice-btn" data-value="button"><span>button</span><small>A general button with no form job yet.</small></button><button type="button" class="quest-choice-btn" data-value="reset"><span>reset</span><small>Clears the form fields.</small></button>
    </div>
    <p class="quest-status" id="lesson5-12-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 60,
    validator: function(code) { return code.includes("<!-- SUBMIT_READY -->") && new RegExp("<\\s*button\\b[^>]*\\btype\\s*=\\s*(?:['\"]submit['\"]|submit)", 'i').test(code); }
};