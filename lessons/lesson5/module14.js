window.Lessons.lesson5.modules[13] = {
    title: "14. Textarea Rows",
    body: `<section class="quest-body">
    <p class="quest-kicker">Mission Brief</p>
    <h3 class="quest-title">14. Textarea Rows</h3>
    <p class="quest-summary">The <code>rows</code> attribute changes how tall the textarea starts.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">More rows means a taller message box.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Compare the short box and the taller box.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add <code>rows="5"</code> to the textarea.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Rows controls starting height.</div>
    <p class="quest-mission">Mission: Make the textarea start with 5 rows.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-more-room" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-more-room)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="206" height="14" rx="7" fill="url(#form-glow-more-room)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">More room</text>
  </svg></div>
<div class="quest-widget-shell quest-toggle-shell" data-quest-toggle="true" data-marker="">
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Short textarea vs tall textarea</h4>
      </div>
      <span class="quest-chip">rows</span>
    </div>
    <div class="quest-toggle-tabs">
      <button type="button" class="quest-toggle-btn is-active" data-target="lesson5-14-panel-0">2 rows</button><button type="button" class="quest-toggle-btn" data-target="lesson5-14-panel-1">5 rows</button>
    </div>
    <div class="quest-toggle-panels">
      <div class="quest-toggle-panel is-active" id="lesson5-14-panel-0"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="display:grid;gap:6px;margin-bottom:10px;"><div style="font:700 12px/1.2 sans-serif;color:#0f172a;letter-spacing:0.04em;">Message</div><div style="min-height:48px;padding:12px;border-radius:12px;background:white;border:1px solid #93c5fd;color:#64748b;font:600 13px/1.4 sans-serif;">Short box</div></div></div></div><div class="quest-toggle-panel" id="lesson5-14-panel-1"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="display:grid;gap:6px;margin-bottom:10px;"><div style="font:700 12px/1.2 sans-serif;color:#0f172a;letter-spacing:0.04em;">Message</div><div style="min-height:108px;padding:12px;border-radius:12px;background:white;border:1px solid #93c5fd;color:#64748b;font:600 13px/1.4 sans-serif;">More writing room</div></div></div></div>
    </div>
    <p class="quest-status">The rows attribute controls the starting height.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 70,
    validator: function(code) { return new RegExp("<\\s*textarea\\b[^>]*\\brows\\s*=\\s*(?:['\"]5['\"]|5)", 'i').test(code); }
};