window.Lessons.lesson5.modules[8] = {
    ...
    <h3 class="quest-title">9. Labels Help Humans</h3>
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-label-the-field" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-label-the-field)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="140" height="14" rx="7" fill="url(#form-glow-label-the-field)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Label the field</text>
  </svg></div>
<div class="quest-widget-shell quest-sequence-shell"
    ...
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Build the field in order.</h4>
      </div>
    ...
    <div class="quest-sequence-buttons">
      <button type="button" class="quest-sequence-btn" data-value="label">Place the label</button><button type="button" class="quest-sequence-btn" data-value="input">Place the input</button>
    </div>
    <p class="quest-status" id="lesson5-9-status">Tap the buttons in the correct order.</p>
  </div>
<script>
(function() {
