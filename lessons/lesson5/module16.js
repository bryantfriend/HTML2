window.Lessons.lesson5.modules[15] = {
    ...
    <h3 class="quest-title">16. More Options</h3>
    <p class="quest-summary">A dropdown becomes useful when it offers a few choices.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Each option becomes one line in the menu.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Imagine a lunch menu with several choices.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Add at least 3 <code>&lt;option&gt;</code> tags.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Each option is its own tag.</div>
    <p class="quest-mission">Mission: Create 3 options inside the select.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-more-choices" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-more-choices)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="226" height="14" rx="7" fill="url(#form-glow-more-choices)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">More choices</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="OPTION_READY"
      data-success="Great. Multiple choices make the dropdown useful."
      data-retry="Nice try. Pick the card that matches the mission."
      data-correct="pizza|salad|pasta"
      data-multi="true">
    <div class="quest-widget-top">
      <div>
        <p class="quest-widget-kicker">Mini Game</p>
        <h4 class="quest-widget-title">Pack the dropdown with menu choices.</h4>
      </div>
      <span class="quest-chip">3 cards</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Tap the 3 foods you want to add to the lunch menu preview.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="pizza"><span>Pizza</span><small>One menu choice.</small></button><button type="button" class="quest-choice-btn" data-value="salad"><span>Salad</span><small>Another menu choice.</small></button><button type="button" class="quest-choice-btn" data-value="pasta"><span>Pasta</span><small>Another menu choice.</small></button><button type="button" class="quest-choice-btn" data-value="title"><span>Main Title</span><small>This is page text, not a dropdown option.</small></button>
    </div>
    <p class="quest-status" id="lesson5-16-status">Find every correct card.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 80,
    validator: function(code) { return code.includes("<!-- OPTION_READY -->") && (code.match(/<\s*option\b/gi) || []).length >= 3; }
};