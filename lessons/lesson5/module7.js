window.Lessons.lesson5.modules[6] = {
    ...
    <h3 class="quest-title">7. Radio Buttons</h3>
    <p class="quest-summary">Radio buttons are for one choice from a group, like choosing one team color.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">Only one radio choice should win.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Tap the best example of a radio-button question.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Change the input to <code>type="radio"</code>.<br>Type this full tag: <code>&lt;input type="radio"&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Radio = pick one answer.</div>
    <p class="quest-mission">Mission: Solve the mini game, then add a radio input.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-pick-one" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-pick-one)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="152" height="14" rx="7" fill="url(#form-glow-pick-one)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Pick one</text>
  </svg></div>
<div class="quest-widget-shell quest-choice-shell"
      data-quest-choice="true"
      data-marker="RADIO_READY"
      data-success="Exactly. Radio buttons are for one answer."
    ...
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Which question should use radio buttons?</h4>
      </div>
      <span class="quest-chip">pick one</span>
    </div>
    <div class="quest-choice-scene"></div>
    <p class="quest-choice-prompt">Tap the question where a person should choose only one answer.</p>
    <div class="quest-choice-grid quest-choice-grid-2">
      <button type="button" class="quest-choice-btn" data-value="jersey"><span>Choose your jersey size</span><small>A person should pick one size.</small></button><button type="button" class="quest-choice-btn" data-value="snacks"><span>Pick your snacks</span><small>A person could want many snacks.</small></button><button type="button" class="quest-choice-btn" data-value="skills"><span>Mark your skills</span><small>A person can have many skills.</small></button>
    </div>
    <p class="quest-status" id="lesson5-7-status">Tap the best answer.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 35,
    validator: function(code) { return code.includes("<!-- RADIO_READY -->") && new RegExp("<\\s*input\\b[^>]*\\btype\\s*=\\s*(?:['\"]radio['\"]|radio)", 'i').test(code); }
};