window.Lessons.lesson5.modules[7] = {
    ...
    <h3 class="quest-title">8. Placeholder Hints</h3>
    <p class="quest-summary">A placeholder shows a helpful hint inside an empty input box.</p>
    <div class="quest-step-grid">
      <div class="quest-step-card"><p class="quest-step-label">Watch</p><p class="quest-step-copy">See the hint text appear inside the box.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Play</p><p class="quest-step-copy">Read the hint before you type.</p></div>
      <div class="quest-step-card"><p class="quest-step-label">Type</p><p class="quest-step-copy">Type or copy the full tag: <code>&lt;input type="text" placeholder="Enter your name"&gt;</code>.</p></div>
    </div>
    <div class="quest-memory"><strong>Remember:</strong> Placeholder is a hint, not the real answer.</div>
    <p class="quest-mission">Mission: Add a helpful placeholder to the input.</p>
  </section>`,
    svg: ``,
...
<div class="quest-hero"><svg class="quest-svg-stage" viewBox="0 0 320 140" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <linearGradient id="form-glow-add-a-hint" x1="0%" x2="100%" y1="0%" y2="100%">
    ...
    <rect x="44" y="44" width="100" height="12" rx="6" fill="url(#form-glow-add-a-hint)" opacity="0.95"/>
    <rect x="44" y="68" width="232" height="16" rx="8" fill="#e0f2fe" opacity="0.92"/>
    <rect x="44" y="92" width="230" height="14" rx="7" fill="url(#form-glow-add-a-hint)"/>
    <text x="242" y="48" fill="#bae6fd" font-size="12" font-family="Arial, sans-serif" text-anchor="end">Add a hint</text>
  </svg></div>
<div class="quest-widget-shell quest-toggle-shell" data-quest-toggle="true" data-marker="">
    <div class="quest-widget-top">
      <div>
        ...
        <h4 class="quest-widget-title">Empty box vs hinted box</h4>
      </div>
      <span class="quest-chip">hint text</span>
    </div>
    <div class="quest-toggle-tabs">
      <button type="button" class="quest-toggle-btn is-active" data-target="lesson5-8-panel-0">Empty</button><button type="button" class="quest-toggle-btn" data-target="lesson5-8-panel-1">Hint</button>
    </div>
    <div class="quest-toggle-panels">
      <div class="quest-toggle-panel is-active" id="lesson5-8-panel-0"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="display:grid;gap:6px;margin-bottom:10px;"><div style="font:700 12px/1.2 sans-serif;color:#0f172a;letter-spacing:0.04em;">Name</div><div style="padding:10px 12px;border-radius:12px;background:white;border:1px solid #93c5fd;color:#475569;font:600 13px/1.2 sans-serif;">&nbsp;</div></div></div></div><div class="quest-toggle-panel" id="lesson5-8-panel-1"><div style="width:100%;max-width:250px;padding:14px;border-radius:20px;background:linear-gradient(180deg,#f8fbff,#e0f2fe);box-shadow:inset 0 0 0 1px rgba(96,165,250,0.18);"><div style="display:grid;gap:6px;margin-bottom:10px;"><div style="font:700 12px/1.2 sans-serif;color:#0f172a;letter-spacing:0.04em;">Name</div><div style="padding:10px 12px;border-radius:12px;background:white;border:1px solid #93c5fd;color:#475569;font:600 13px/1.2 sans-serif;">Enter your name</div></div></div></div>
    </div>
    <p class="quest-status">The hint helps the user know what to type.</p>
  </div>
<script>
(function() {
  ...
  document.querySelectorAll('[data-quest-toggle="true"]').forEach(function(root) {
    ...
    progress: 40,
    validator: function(code) { return new RegExp("<\\s*input\\b[^>]*\\bplaceholder\\s*=\\s*(?:['\"]Enter your name['\"]|Enter your name)", 'i').test(code); }
};